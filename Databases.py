...
class Comp(Enum):
    ...
    Mg_Chloritoid = Species("Mg-Chloritoid", None, ["Mg", "Al", "Si", "O", "H"], 0.22036525599999998, 0, PhaseType.MINERAL)
    ...
    Pumpellyite_FeAl = Species("Pumpellyite-FeAl", None, ["Ca", "Fe", "Al", "Si", "O", "H"], 0.97461647, 0, PhaseType.MINERAL)
    Pumpellyite_MgAl = Species("Pumpellyite-MgAl", None, ["Ca", "Mg", "Al", "Si", "O", "H"], 0.94307647, 0, PhaseType.MINERAL)
    ...
    Epidote_ordered = Species("Epidote,ordered", None, ["Ca", "Fe", "Al", "Si", "O", "H"], 0.483220716, 0, PhaseType.MINERAL)
    Fe_Epidote = Species("Fe-Epidote", None, ["Ca", "Fe", "Al", "Si", "O", "H"], 0.5120841780000001, 0, PhaseType.MINERAL)
    Lawsonite = Species("Lawsonite", None, ["Ca", "Al", "Si", "O", "H"], 0.314237836, 0, PhaseType.MINERAL)
    Piemontite_ordered = Species("Piemontite,ordered", None, ["Ca", "Mn", "Al", "Si", "O", "H"], 0.48231376600000003, 0, PhaseType.MINERAL)
    ...
    Ferroactinolite = Species("Ferroactinolite", None, ["Ca", "Fe", "Si", "O", "H"], 0.9700664800000001, 0, PhaseType.MINERAL)
    Ferroglaucophane = Species("Ferroglaucophane", None, ["Na", "Fe", "Al", "Si", "O", "H"], 0.878163096, 0, PhaseType.MINERAL)
    ...
    Magnesiocarpholite = Species("Magnesiocarpholite", None, ["Mg", "Al", "Si", "O", "H"], 0.298464836, 0, PhaseType.MINERAL)
    ...
    Ferroceladonite = Species("Ferroceladonite", None, ["K", "Fe", "Al", "Si", "O", "H"], 0.428275518, 0, PhaseType.MINERAL)
    ...
    Mn_Biotite = Species("Mn-Biotite", None, ["K", "Mn", "Al", "Si", "O", "H"], 0.5091591679999999, 0, PhaseType.MINERAL)
    Muscovite = Species("Muscovite", None, ["K", "Al", "Si", "O", "H"], 0.39830809400000006, 0, PhaseType.MINERAL)
    Sodaphlogopite = Species("Sodaphlogopite", None, ["Na", "Mg", "Al", "Si", "O", "H"], 0.40115148800000006, 0, PhaseType.MINERAL)
    Paragonite = Species("Paragonite", None, ["Na", "Al", "Si", "O", "H"], 0.38219956400000005, 0, PhaseType.MINERAL)
    Phlogopite = Species("Phlogopite", None, ["K", "Mg", "Al", "Si", "O", "H"], 0.41726001800000007, 0, PhaseType.MINERAL)
    ...
    Clinochlore_ordered = Species("Clinochlore,ordered", None, ["Mg", "Al", "Si", "O", "H"], 0.555797296, 0, PhaseType.MINERAL)
    ...
    Mg_Minnesotaite = Species("Mg-Minnesotaite", None, ["Mg", "Si", "O", "H"], 0.37926568000000005, 0, PhaseType.MINERAL)
    ...
    Ferrostilpnomelane = Species("Ferrostilpnomelane", None, ["K", "Fe", "Al", "Si", "O", "H"], 1.078002176, 0, PhaseType.MINERAL)
    Mg_Stilpnomelane = Species("Mg-Stilpnomelane", None, ["K", "Mg", "Al", "Si", "O", "H"], 0.920302176, 0, PhaseType.MINERAL)
    Talc = Species("Talc", None, ["Mg", "Si", "O", "H"], 0.37926568000000005, 0, PhaseType.MINERAL)
    Tschermak_Talc = Species("Tschermak-Talc", None, ["Mg", "Al", "Si", "O", "H"], 0.38083825600000004, 0, PhaseType.MINERAL)
    Ferri_Prehnite = Species("Ferri-Prehnite", None, ["Ca", "Fe", "Al", "Si", "O", "H"], 0.44124771800000007, 0, PhaseType.MINERAL)
    ...
    Carnegieite_high = Species("Carnegieite,high", None, ["Na", "Al", "Si", "O"], 0.14205440800000002, 0, PhaseType.MINERAL)
    Carnegieite_low = Species("Carnegieite,low", None, ["Na", "Al", "Si", "O"], 0.14205440800000002, 0, PhaseType.MINERAL)
    ...
    Fluorphlogopite = Species("Fluorphlogopite", None, ["K", "Mg", "Al", "Si", "O", "F"], 0.42124214400000004, 0, PhaseType.MINERAL)
    ...
    Beidellite_Ca = Species("Beidellite-Ca", None, ["Ca", "Al", "Si", "O", "H"], 0.36656231854000004, 0, PhaseType.MINERAL)
    ...
    Beidellite_Mg = Species("Beidellite-Mg", None, ["Mg", "Al", "Si", "O", "H"], 0.36395977354000003, 0, PhaseType.MINERAL)
    Beidellite_Na = Species("Beidellite-Na", None, ["Na", "Al", "Si", "O", "H"], 0.36753607264000004, 0, PhaseType.MINERAL)
    Montmorillonite_Ca = Species("Montmorillonite-Ca", None, ["Ca", "Mg", "Al", "Si", "O", "H"], 0.36604336846, 0, PhaseType.MINERAL)
    Montmorillonite_K = Species("Montmorillonite-K", None, ["K", "Mg", "Al", "Si", "O", "H"], 0.37233293746, 0, PhaseType.MINERAL)
    Montmorillonite_Mg = Species("Montmorillonite-Mg", None, ["Mg", "Al", "Si", "O", "H"], 0.36344082346, 0, PhaseType.MINERAL)
    Montmorillonite_Na = Species("Montmorillonite-Na", None, ["Na", "Mg", "Al", "Si", "O", "H"], 0.36701712256, 0, PhaseType.MINERAL)
    Nontronite_Ca = Species("Nontronite-Ca", None, ["Ca", "Fe", "Al", "Si", "O", "H"], 0.42428924254000006, 0, PhaseType.MINERAL)
    Nontronite_Mg = Species("Nontronite-Mg", None, ["Mg", "Fe", "Al", "Si", "O", "H"], 0.42168669754000004, 0, PhaseType.MINERAL)
    Nontronite_H = Species("Nontronite-H", None, ["Fe", "Al", "Si", "O", "H"], 0.41800899274000003, 0, PhaseType.MINERAL)
    Nontronite_K = Species("Nontronite-K", None, ["K", "Fe", "Al", "Si", "O", "H"], 0.43057881154000005, 0, PhaseType.MINERAL)
    Nontronite_Na = Species("Nontronite-Na", None, ["Na", "Fe", "Al", "Si", "O", "H"], 0.42526299664000006, 0, PhaseType.MINERAL)
    ...
    Ca_Tschermaks_Px = Species("Ca-Tschermaks-Px", None, ["Ca", "Al", "Si", "O"], 0.21812297600000002, 0, PhaseType.MINERAL)
    ...
    Ag_CO3_minus = Species("Ag(CO3)-", None, ["Ag", "C", "O"], 0.8321229, -1.0, PhaseType.AQUEOUS)
    Ag_CO3_2_minus3 = Species("Ag(CO3)2-3", None, ["Ag", "C", "O"], 2.7721139999999997, -3.0, PhaseType.AQUEOUS)
    Ag_plus = Species("Ag+", None, ["Ag"], 1.1078682, 1.0, PhaseType.AQUEOUS)
    Ag_plus2 = Species("Ag+2", None, ["Ag"], 2.1078682, 2.0, PhaseType.AQUEOUS)
    AgCl_aq = Species("AgCl(aq)", None, ["Ag", "Cl"], 0.14332119999999998, 0.0, PhaseType.AQUEOUS)
    AgCl2_minus = Species("AgCl2-", None, ["Ag", "Cl"], 0.8212258, -1.0, PhaseType.AQUEOUS)
    AgCl3_minus2 = Species("AgCl3-2", None, ["Ag", "Cl"], 1.7857728, -2.0, PhaseType.AQUEOUS)
    AgCl4_minus3 = Species("AgCl4-3", None, ["Ag", "Cl"], 2.7503198, -3.0, PhaseType.AQUEOUS)
    AgOH_aq = Species("AgOH(aq)", None, ["Ag", "O", "H"], 0.12487554, 0.0, PhaseType.AQUEOUS)
    AgO_minus = Species("AgO-", None, ["Ag", "O"], 0.8761324, -1.0, PhaseType.AQUEOUS)
    AgNO3_aq = Species("AgNO3(aq)", None, ["Ag", "N", "O"], 0.1698731, 0.0, PhaseType.AQUEOUS)
    AlOH_plus2 = Species("AlOH+2", None, ["Al", "O", "H"], 2.043988878, 2.0, PhaseType.AQUEOUS)
    Al_plus3 = Species("Al+3", None, ["Al"], 3.026981538, 3.0, PhaseType.AQUEOUS)
    AlH3SiO4_plus2 = Species("AlH3SiO4+2", None, ["Al", "H", "Si", "O"], 2.122088458, 2.0, PhaseType.AQUEOUS)
    Al_OH_3_aq = Species("Al(OH)3(aq)", None, ["Al", "O", "H"], 0.078003558, 0.0, PhaseType.AQUEOUS)
    Al_OH_4_minus = Species("Al(OH)4-", None, ["Al", "O", "H"], 0.9049891019999999, -1.0, PhaseType.AQUEOUS)
    Al_OH_2_plus = Species("Al(OH)2+", None, ["Al", "O", "H"], 1.060996218, 1.0, PhaseType.AQUEOUS)
    Au_plus = Species("Au+", None, ["Au"], 1.19696655, 1.0, PhaseType.AQUEOUS)
    Au_plus3 = Species("Au+3", None, ["Au"], 3.19696655, 3.0, PhaseType.AQUEOUS)
    B_OH_3_aq = Species("B(OH)3(aq)", None, ["B", "O", "H"], 0.06183302, 0.0, PhaseType.AQUEOUS)
    BF4_minus = Species("BF4-", None, ["B", "F"], 0.913195388, -1.0, PhaseType.AQUEOUS)
    BO2_minus = Species("BO2-", None, ["B", "O"], 0.9571902, -1.0, PhaseType.AQUEOUS)
    Ba_HCO3_plus = Species("Ba(HCO3)+", None, ["Ba", "H", "C", "O"], 1.1983438400000002, 1.0, PhaseType.AQUEOUS)
    Ba_plus2 = Species("Ba+2", None, ["Ba"], 2.137327, 2.0, PhaseType.AQUEOUS)
    BaCl_plus = Species("BaCl+", None, ["Ba", "Cl"], 1.17278, 1.0, PhaseType.AQUEOUS)
    BaOH_plus = Species("BaOH+", None, ["Ba", "O", "H"], 1.1543343400000001, 1.0, PhaseType.AQUEOUS)
    Be_plus2 = Species("Be+2", None, ["Be"], 2.009012182, 2.0, PhaseType.AQUEOUS)
    BeOH_plus = Species("BeOH+", None, ["Be", "O", "H"], 1.0260195220000001, 1.0, PhaseType.AQUEOUS)
    BeO_aq = Species("BeO(aq)", None, ["Be", "O"], 0.025011582, 0.0, PhaseType.AQUEOUS)
    HBeO2_minus = Species("HBeO2-", None, ["H", "Be", "O"], 0.957981078, -1.0, PhaseType.AQUEOUS)
    BeO2_minus2 = Species("BeO2-2", None, ["Be", "O"], 1.958989018, -2.0, PhaseType.AQUEOUS)
    Br_minus = Species("Br-", None, ["Br"], 0.920096, -1.0, PhaseType.AQUEOUS)
    Br3_minus = Species("Br3-", None, ["Br"], 0.760288, -1.0, PhaseType.AQUEOUS)
    HBrO_aq = Species("HBrO(aq)", None, ["H", "Br", "O"], 0.09691134, 0.0, PhaseType.AQUEOUS)
    BrO_minus = Species("BrO-", None, ["Br", "O"], 0.9040966, -1.0, PhaseType.AQUEOUS)
    BrO3_minus = Species("BrO3-", None, ["Br", "O"], 0.8720978, -1.0, PhaseType.AQUEOUS)
    BrO4_minus = Species("BrO4-", None, ["Br", "O"], 0.8560984, -1.0, PhaseType.AQUEOUS)
    CaOH_plus = Species("CaOH+", None, ["Ca", "O", "H"], 1.0570853400000002, 1.0, PhaseType.AQUEOUS)
    Ce_plus4 = Species("Ce+4", None, ["Ce"], 4.140116, 4.0, PhaseType.AQUEOUS)
    ...
    CO3_minus2 = Species("CO3-2", None, ["C", "O"], 1.9399910999999999, -2.0, PhaseType.AQUEOUS)
    Ca_HCO3_plus = Species("Ca(HCO3)+", None, ["Ca", "H", "C", "O"], 1.1010948400000002, 1.0, PhaseType.AQUEOUS)
    Ca_plus2 = Species("Ca+2", None, ["Ca"], 2.040078, 2.0, PhaseType.AQUEOUS)
    CaCl_plus = Species("CaCl+", None, ["Ca", "Cl"], 1.075531, 1.0, PhaseType.AQUEOUS)
    CaCl2_aq = Species("CaCl2(aq)", None, ["Ca", "Cl"], 0.110984, 0.0, PhaseType.AQUEOUS)
    CaF_plus = Species("CaF+", None, ["Ca", "F"], 1.0590764030000002, 1.0, PhaseType.AQUEOUS)
    CaSO4_aq = Species("CaSO4(aq)", None, ["Ca", "S", "O"], 0.1361406, 0.0, PhaseType.AQUEOUS)
    Cd_plus2 = Species("Cd+2", None, ["Cd"], 2.112411, 2.0, PhaseType.AQUEOUS)
    CdOH_plus = Species("CdOH+", None, ["Cd", "O", "H"], 1.1294183400000002, 1.0, PhaseType.AQUEOUS)
    CdO_aq = Species("CdO(aq)", None, ["Cd", "O"], 0.1284104, 0.0, PhaseType.AQUEOUS)
    HCdO2_minus = Species("HCdO2-", None, ["H", "Cd", "O"], 0.8545822599999999, -1.0, PhaseType.AQUEOUS)
    CdO2_minus2 = Species("CdO2-2", None, ["Cd", "O"], 1.8555902, -2.0, PhaseType.AQUEOUS)
    Ce_plus2 = Species("Ce+2", None, ["Ce"], 2.140116, 2.0, PhaseType.AQUEOUS)
    Ce_plus3 = Species("Ce+3", None, ["Ce"], 3.140116, 3.0, PhaseType.AQUEOUS)
    Cl_minus = Species("Cl-", None, ["Cl"], 0.964547, -1.0, PhaseType.AQUEOUS)
    HClO_aq = Species("HClO(aq)", None, ["H", "Cl", "O"], 0.052460339999999994, 0.0, PhaseType.AQUEOUS)
    ClO_minus = Species("ClO-", None, ["Cl", "O"], 0.9485476, -1.0, PhaseType.AQUEOUS)
    ClO2_minus = Species("ClO2-", None, ["Cl", "O"], 0.9325482, -1.0, PhaseType.AQUEOUS)
    ClO3_minus = Species("ClO3-", None, ["Cl", "O"], 0.9165488, -1.0, PhaseType.AQUEOUS)
    ClO4_minus = Species("ClO4-", None, ["Cl", "O"], 0.9005494, -1.0, PhaseType.AQUEOUS)
    Co_plus2 = Species("Co+2", None, ["Co"], 2.0589332, 2.0, PhaseType.AQUEOUS)
    Co_plus3 = Species("Co+3", None, ["Co"], 3.0589332, 3.0, PhaseType.AQUEOUS)
    CoOH_plus = Species("CoOH+", None, ["Co", "O", "H"], 1.0759405400000002, 1.0, PhaseType.AQUEOUS)
    CoO_aq = Species("CoO(aq)", None, ["Co", "O"], 0.0749326, 0.0, PhaseType.AQUEOUS)
    HCoO2_minus = Species("HCoO2-", None, ["H", "Co", "O"], 0.90806006, -1.0, PhaseType.AQUEOUS)
    CoO2_minus2 = Species("CoO2-2", None, ["Co", "O"], 1.909068, -2.0, PhaseType.AQUEOUS)
    CoOH_plus2 = Species("CoOH+2", None, ["Co", "O", "H"], 2.07594054, 2.0, PhaseType.AQUEOUS)
    Cr2O7_minus2 = Species("Cr2O7-2", None, ["Cr", "O"], 1.784012, -2.0, PhaseType.AQUEOUS)
    CrO4_minus2 = Species("CrO4-2", None, ["Cr", "O"], 1.8840063, -2.0, PhaseType.AQUEOUS)
    Cs_plus = Species("Cs+", None, ["Cs"], 1.13290545, 1.0, PhaseType.AQUEOUS)
    ...
    Cu_plus = Species("Cu+", None, ["Cu"], 1.063546, 1.0, PhaseType.AQUEOUS)
    Cu_plus2 = Species("Cu+2", None, ["Cu"], 2.063546, 2.0, PhaseType.AQUEOUS)
    CuOH_plus = Species("CuOH+", None, ["Cu", "O", "H"], 1.0805533400000003, 1.0, PhaseType.AQUEOUS)
    CuO_aq = Species("CuO(aq)", None, ["Cu", "O"], 0.0795454, 0.0, PhaseType.AQUEOUS)
    HCuO2_minus = Species("HCuO2-", None, ["H", "Cu", "O"], 0.90344726, -1.0, PhaseType.AQUEOUS)
    CuO2_minus2 = Species("CuO2-2", None, ["Cu", "O"], 1.9044552, -2.0, PhaseType.AQUEOUS)
    Dy_plus2 = Species("Dy+2", None, ["Dy"], 2.1625, 2.0, PhaseType.AQUEOUS)
    Dy_plus3 = Species("Dy+3", None, ["Dy"], 3.1625, 3.0, PhaseType.AQUEOUS)
    Dy_plus4 = Species("Dy+4", None, ["Dy"], 4.1625, 4.0, PhaseType.AQUEOUS)
    Er_plus2 = Species("Er+2", None, ["Er"], 2.167259, 2.0, PhaseType.AQUEOUS)
    Er_plus3 = Species("Er+3", None, ["Er"], 3.167259, 3.0, PhaseType.AQUEOUS)
    Er_plus4 = Species("Er+4", None, ["Er"], 4.167259, 4.0, PhaseType.AQUEOUS)
    Eu_plus2 = Species("Eu+2", None, ["Eu"], 2.151964, 2.0, PhaseType.AQUEOUS)
    Eu_plus3 = Species("Eu+3", None, ["Eu"], 3.151964, 3.0, PhaseType.AQUEOUS)
    Eu_plus4 = Species("Eu+4", None, ["Eu"], 4.1519639999999995, 4.0, PhaseType.AQUEOUS)
    F_minus = Species("F-", None, ["F"], 0.981001597, -1.0, PhaseType.AQUEOUS)
    Fe_plus2 = Species("Fe+2", None, ["Fe"], 2.055845, 2.0, PhaseType.AQUEOUS)
    Fe_plus3 = Species("Fe+3", None, ["Fe"], 3.055845, 3.0, PhaseType.AQUEOUS)
    FeCl_plus = Species("FeCl+", None, ["Fe", "Cl"], 1.0912979999999999, 1.0, PhaseType.AQUEOUS)
    FeCl2_aq = Species("FeCl2(aq)", None, ["Fe", "Cl"], 0.126751, 0.0, PhaseType.AQUEOUS)
    FeOH_plus2 = Species("FeOH+2", None, ["Fe", "O", "H"], 2.0728523400000003, 2.0, PhaseType.AQUEOUS)
    FeOH_plus = Species("FeOH+", None, ["Fe", "O", "H"], 1.07285234, 1.0, PhaseType.AQUEOUS)
    FeO_plus = Species("FeO+", None, ["Fe", "O"], 1.0718444, 1.0, PhaseType.AQUEOUS)
    FeO_aq = Species("FeO(aq)", None, ["Fe", "O"], 0.0718444, 0.0, PhaseType.AQUEOUS)
    HFeO2_minus = Species("HFeO2-", None, ["H", "Fe", "O"], 0.9111482599999999, -1.0, PhaseType.AQUEOUS)
    HFeO2_aq = Species("HFeO2(aq)", None, ["H", "Fe", "O"], 0.08885174, 0.0, PhaseType.AQUEOUS)
    FeO2_minus = Species("FeO2-", None, ["Fe", "O"], 0.9121562, -1.0, PhaseType.AQUEOUS)
    Ga_plus3 = Species("Ga+3", None, ["Ga"], 3.069723, 3.0, PhaseType.AQUEOUS)
    GaOH_plus2 = Species("GaOH+2", None, ["Ga", "O", "H"], 2.0867303400000003, 2.0, PhaseType.AQUEOUS)
    GaO_plus = Species("GaO+", None, ["Ga", "O"], 1.0857224, 1.0, PhaseType.AQUEOUS)
    HGaO2_aq = Species("HGaO2(aq)", None, ["H", "Ga", "O"], 0.10272973999999999, 0.0, PhaseType.AQUEOUS)
    GaO2_minus = Species("GaO2-", None, ["Ga", "O"], 0.8982782, -1.0, PhaseType.AQUEOUS)
    Gd_plus2 = Species("Gd+2", None, ["Gd"], 2.15725, 2.0, PhaseType.AQUEOUS)
    Gd_plus3 = Species("Gd+3", None, ["Gd"], 3.15725, 3.0, PhaseType.AQUEOUS)
    Gd_plus4 = Species("Gd+4", None, ["Gd"], 4.15725, 4.0, PhaseType.AQUEOUS)
    H_plus = Species("H+", None, ["H"], 1.00100794, 1.0, PhaseType.AQUEOUS)
    ...
    MgH2AsO4_plus = Species("MgH2AsO4+", None, ["Mg", "H", "As", "O"], 1.16524008, 1.0, PhaseType.AQUEOUS)
    CaH2AsO4_plus = Species("CaH2AsO4+", None, ["Ca", "H", "As", "O"], 1.18101308, 1.0, PhaseType.AQUEOUS)
    SrH2AsO4_plus = Species("SrH2AsO4+", None, ["Sr", "H", "As", "O"], 1.22855508, 1.0, PhaseType.AQUEOUS)
    MnH2AsO4_plus = Species("MnH2AsO4+", None, ["Mn", "H", "As", "O"], 1.19587313, 1.0, PhaseType.AQUEOUS)
    FeH2AsO4_plus = Species("FeH2AsO4+", None, ["Fe", "H", "As", "O"], 1.19678008, 1.0, PhaseType.AQUEOUS)
    CoH2AsO4_plus = Species("CoH2AsO4+", None, ["Co", "H", "As", "O"], 1.19986828, 1.0, PhaseType.AQUEOUS)
    NiH2AsO4_plus = Species("NiH2AsO4+", None, ["Ni", "H", "As", "O"], 1.1996284799999999, 1.0, PhaseType.AQUEOUS)
    CuH2AsO4_plus = Species("CuH2AsO4+", None, ["Cu", "H", "As", "O"], 1.20448108, 1.0, PhaseType.AQUEOUS)
    ZnH2AsO4_plus = Species("ZnH2AsO4+", None, ["Zn", "H", "As", "O"], 1.20634408, 1.0, PhaseType.AQUEOUS)
    PbH2AsO4_plus = Species("PbH2AsO4+", None, ["Pb", "H", "As", "O"], 1.34813508, 1.0, PhaseType.AQUEOUS)
    AlH2AsO4_plus2 = Species("AlH2AsO4+2", None, ["Al", "H", "As", "O"], 2.167916618, 2.0, PhaseType.AQUEOUS)
    FeH2AsO4_plus2 = Species("FeH2AsO4+2", None, ["Fe", "H", "As", "O"], 2.1967800800000004, 2.0, PhaseType.AQUEOUS)
    NaHAsO4_minus = Species("NaHAsO4-", None, ["Na", "H", "As", "O"], 0.8370830899999999, -1.0, PhaseType.AQUEOUS)
    KHAsO4_minus = Species("KHAsO4-", None, ["K", "H", "As", "O"], 0.8209745599999999, -1.0, PhaseType.AQUEOUS)
    ...
    AlHAsO4_plus = Species("AlHAsO4+", None, ["Al", "H", "As", "O"], 1.166908678, 1.0, PhaseType.AQUEOUS)
    FeHAsO4_plus = Species("FeHAsO4+", None, ["Fe", "H", "As", "O"], 1.1957721399999999, 1.0, PhaseType.AQUEOUS)
    NaAsO4_minus2 = Species("NaAsO4-2", None, ["Na", "As", "O"], 1.8380910300000002, -2.0, PhaseType.AQUEOUS)
    KAsO4_minus2 = Species("KAsO4-2", None, ["K", "As", "O"], 1.8219825, -2.0, PhaseType.AQUEOUS)
    MgAsO4_minus = Species("MgAsO4-", None, ["Mg", "As", "O"], 0.8367758, -1.0, PhaseType.AQUEOUS)
    CaAsO4_minus = Species("CaAsO4-", None, ["Ca", "As", "O"], 0.8210027999999999, -1.0, PhaseType.AQUEOUS)
    SrAsO4_minus = Species("SrAsO4-", None, ["Sr", "As", "O"], 0.7734608, -1.0, PhaseType.AQUEOUS)
    MnAsO4_minus = Species("MnAsO4-", None, ["Mn", "As", "O"], 0.80614275, -1.0, PhaseType.AQUEOUS)
    FeAsO4_minus = Species("FeAsO4-", None, ["Fe", "As", "O"], 0.8052358, -1.0, PhaseType.AQUEOUS)
    CoAsO4_minus = Species("CoAsO4-", None, ["Co", "As", "O"], 0.8021476, -1.0, PhaseType.AQUEOUS)
    NiAsO4_minus = Species("NiAsO4-", None, ["Ni", "As", "O"], 0.8023874, -1.0, PhaseType.AQUEOUS)
    CuAsO4_minus = Species("CuAsO4-", None, ["Cu", "As", "O"], 0.7975348, -1.0, PhaseType.AQUEOUS)
    ZnAsO4_minus = Species("ZnAsO4-", None, ["Zn", "As", "O"], 0.7956717999999999, -1.0, PhaseType.AQUEOUS)
    PbAsO4_minus = Species("PbAsO4-", None, ["Pb", "As", "O"], 0.6538807999999999, -1.0, PhaseType.AQUEOUS)
    ...
    MgH2AsO3_plus = Species("MgH2AsO3+", None, ["Mg", "H", "As", "O"], 1.1492406800000001, 1.0, PhaseType.AQUEOUS)
    CaH2AsO3_plus = Species("CaH2AsO3+", None, ["Ca", "H", "As", "O"], 1.1650136800000002, 1.0, PhaseType.AQUEOUS)
    SrH2AsO3_plus = Species("SrH2AsO3+", None, ["Sr", "H", "As", "O"], 1.2125556800000001, 1.0, PhaseType.AQUEOUS)
    BaH2AsO3_plus = Species("BaH2AsO3+", None, ["Ba", "H", "As", "O"], 1.26226268, 1.0, PhaseType.AQUEOUS)
    CuH2AsO3_plus = Species("CuH2AsO3+", None, ["Cu", "H", "As", "O"], 1.1884816800000002, 1.0, PhaseType.AQUEOUS)
    PbH2AsO3_plus = Species("PbH2AsO3+", None, ["Pb", "H", "As", "O"], 1.3321356800000002, 1.0, PhaseType.AQUEOUS)
    AlH2AsO3_plus2 = Species("AlH2AsO3+2", None, ["Al", "H", "As", "O"], 2.151917218, 2.0, PhaseType.AQUEOUS)
    FeH2AsO3_plus2 = Species("FeH2AsO3+2", None, ["Fe", "H", "As", "O"], 2.1807806800000002, 2.0, PhaseType.AQUEOUS)
    H2P2O7_minus2 = Species("H2P2O7-2", None, ["H", "P", "O"], 1.8240407979999997, -2.0, PhaseType.AQUEOUS)
    H2PO4_minus = Species("H2PO4-", None, ["H", "P", "O"], 0.903012759, -1.0, PhaseType.AQUEOUS)
    ...
    H2VO4_minus = Species("H2VO4-", None, ["H", "V", "O"], 0.8830450200000001, -1.0, PhaseType.AQUEOUS)
    H3P2O7_minus = Species("H3P2O7-", None, ["H", "P", "O"], 0.823032858, -1.0, PhaseType.AQUEOUS)
    H3PO4_aq = Species("H3PO4(aq)", None, ["H", "P", "O"], 0.097995181, 0.0, PhaseType.AQUEOUS)
    HCO3_minus = Species("HCO3-", None, ["H", "C", "O"], 0.9389831599999999, -1.0, PhaseType.AQUEOUS)
    HCrO4_minus = Species("HCrO4-", None, ["H", "Cr", "O"], 0.88299836, -1.0, PhaseType.AQUEOUS)
    HF_aq = Species("HF(aq)", None, ["H", "F"], 0.020006343, 0.0, PhaseType.AQUEOUS)
    HF2_minus = Species("HF2-", None, ["H", "F"], 0.960995254, -1.0, PhaseType.AQUEOUS)
    HNO3_aq = Species("HNO3(aq)", None, ["H", "N", "O"], 0.06301284, 0.0, PhaseType.AQUEOUS)
    HO2_minus = Species("HO2-", None, ["H", "O"], 0.96699326, -1.0, PhaseType.AQUEOUS)
    HPO4_minus2 = Species("HPO4-2", None, ["H", "P", "O"], 1.904020699, -2.0, PhaseType.AQUEOUS)
    HS_minus = Species("HS-", None, ["H", "S"], 0.96692706, -1.0, PhaseType.AQUEOUS)
    HSO3_minus = Species("HSO3-", None, ["H", "S", "O"], 0.91892886, -1.0, PhaseType.AQUEOUS)
    HSO4_minus = Species("HSO4-", None, ["H", "S", "O"], 0.90292946, -1.0, PhaseType.AQUEOUS)
    HSO5_minus = Species("HSO5-", None, ["H", "S", "O"], 0.88693006, -1.0, PhaseType.AQUEOUS)
    HSe_minus = Species("HSe-", None, ["H", "Se"], 0.9200320599999999, -1.0, PhaseType.AQUEOUS)
    H2SeO3_aq = Species("H2SeO3(aq)", None, ["H", "Se", "O"], 0.12897408, 0.0, PhaseType.AQUEOUS)
    HSeO3_minus = Species("HSeO3-", None, ["H", "Se", "O"], 0.8720338599999999, -1.0, PhaseType.AQUEOUS)
    HSeO4_minus = Species("HSeO4-", None, ["H", "Se", "O"], 0.8560344599999999, -1.0, PhaseType.AQUEOUS)
    HSiO3_minus = Species("HSiO3-", None, ["H", "Si", "O"], 0.92290836, -1.0, PhaseType.AQUEOUS)
    HVO4_minus2 = Species("HVO4-2", None, ["H", "V", "O"], 1.88405296, -2.0, PhaseType.AQUEOUS)
    He_aq = Species("He(aq)", None, ["He"], 0.004002602, 0.0, PhaseType.AQUEOUS)
    Hg_plus2 = Species("Hg+2", None, ["Hg"], 2.20059, 2.0, PhaseType.AQUEOUS)
    HgOH_plus = Species("HgOH+", None, ["Hg", "O", "H"], 1.2175973400000002, 1.0, PhaseType.AQUEOUS)
    HgO_aq = Species("HgO(aq)", None, ["Hg", "O"], 0.2165894, 0.0, PhaseType.AQUEOUS)
    HHgO2_minus = Species("HHgO2-", None, ["H", "Hg", "O"], 0.7664032599999999, -1.0, PhaseType.AQUEOUS)
    Hg2_plus2 = Species("Hg2+2", None, ["Hg"], 2.40118, 2.0, PhaseType.AQUEOUS)
    Ho_plus2 = Species("Ho+2", None, ["Ho"], 2.16493032, 2.0, PhaseType.AQUEOUS)
    Ho_plus3 = Species("Ho+3", None, ["Ho"], 3.16493032, 3.0, PhaseType.AQUEOUS)
    Ho_plus4 = Species("Ho+4", None, ["Ho"], 4.16493032, 4.0, PhaseType.AQUEOUS)
    I_minus = Species("I-", None, ["I"], 0.8730955300000001, -1.0, PhaseType.AQUEOUS)
    I3_minus = Species("I3-", None, ["I"], 0.61928659, -1.0, PhaseType.AQUEOUS)
    HIO_aq = Species("HIO(aq)", None, ["H", "I", "O"], 0.14391181, 0.0, PhaseType.AQUEOUS)
    IO_minus = Species("IO-", None, ["I", "O"], 0.8570961300000001, -1.0, PhaseType.AQUEOUS)
    IO3_minus = Species("IO3-", None, ["I", "O"], 0.8250973300000001, -1.0, PhaseType.AQUEOUS)
    IO4_minus = Species("IO4-", None, ["I", "O"], 0.8090979300000001, -1.0, PhaseType.AQUEOUS)
    In_plus3 = Species("In+3", None, ["In"], 3.114818, 3.0, PhaseType.AQUEOUS)
    InOH_plus2 = Species("InOH+2", None, ["In", "O", "H"], 2.1318253400000002, 2.0, PhaseType.AQUEOUS)
    InO_plus = Species("InO+", None, ["In", "O"], 1.1308174000000002, 1.0, PhaseType.AQUEOUS)
    HInO2_aq = Species("HInO2(aq)", None, ["H", "In", "O"], 0.14782474, 0.0, PhaseType.AQUEOUS)
    InO2_minus = Species("InO2-", None, ["In", "O"], 0.8531832, -1.0, PhaseType.AQUEOUS)
    K_plus = Species("K+", None, ["K"], 1.0390983, 1.0, PhaseType.AQUEOUS)
    ...
    KSO4_minus = Species("KSO4-", None, ["K", "S", "O"], 0.8648391, -1.0, PhaseType.AQUEOUS)
    Kr_aq = Species("Kr(aq)", None, ["Kr"], 0.083798, 0.0, PhaseType.AQUEOUS)
    La_plus3 = Species("La+3", None, ["La"], 3.1389055, 3.0, PhaseType.AQUEOUS)
    Li_plus = Species("Li+", None, ["Li"], 1.006941, 1.0, PhaseType.AQUEOUS)
    ...
    Lu_plus3 = Species("Lu+3", None, ["Lu"], 3.174967, 3.0, PhaseType.AQUEOUS)
    Lu_plus4 = Species("Lu+4", None, ["Lu"], 4.174967, 4.0, PhaseType.AQUEOUS)
    Mg_HCO3_plus = Species("Mg(HCO3)+", None, ["Mg", "H", "C", "O"], 1.0853218400000002, 1.0, PhaseType.AQUEOUS)
    Mg_plus2 = Species("Mg+2", None, ["Mg"], 2.024305, 2.0, PhaseType.AQUEOUS)
    MgCl_plus = Species("MgCl+", None, ["Mg", "Cl"], 1.059758, 1.0, PhaseType.AQUEOUS)
    MgF_plus = Species("MgF+", None, ["Mg", "F"], 1.0433034030000001, 1.0, PhaseType.AQUEOUS)
    MgOH_plus = Species("MgOH+", None, ["Mg", "O", "H"], 1.0413123400000002, 1.0, PhaseType.AQUEOUS)
    Mn_plus2 = Species("Mn+2", None, ["Mn"], 2.05493805, 2.0, PhaseType.AQUEOUS)
    Mn_plus3 = Species("Mn+3", None, ["Mn"], 3.05493805, 3.0, PhaseType.AQUEOUS)
    MnCl_plus = Species("MnCl+", None, ["Mn", "Cl"], 1.09039105, 1.0, PhaseType.AQUEOUS)
    MnOH_plus = Species("MnOH+", None, ["Mn", "O", "H"], 1.0719453900000002, 1.0, PhaseType.AQUEOUS)
    MnO_aq = Species("MnO(aq)", None, ["Mn", "O"], 0.07093745, 0.0, PhaseType.AQUEOUS)
    HMnO2_minus = Species("HMnO2-", None, ["H", "Mn", "O"], 0.91205521, -1.0, PhaseType.AQUEOUS)
    MnO2_minus2 = Species("MnO2-2", None, ["Mn", "O"], 1.91306315, -2.0, PhaseType.AQUEOUS)
    MnO4_minus = Species("MnO4-", None, ["Mn", "O"], 0.88106435, -1.0, PhaseType.AQUEOUS)
    MnO4_minus2 = Species("MnO4-2", None, ["Mn", "O"], 1.88106435, -2.0, PhaseType.AQUEOUS)
    MnSO4_aq = Species("MnSO4(aq)", None, ["Mn", "S", "O"], 0.15100065000000001, 0.0, PhaseType.AQUEOUS)
    HMoO4_minus = Species("HMoO4-", None, ["H", "Mo", "O"], 0.83905446, -1.0, PhaseType.AQUEOUS)
    MoO4_minus2 = Species("MoO4-2", None, ["Mo", "O"], 1.8400624, -2.0, PhaseType.AQUEOUS)
    ...
    NH4_plus = Species("NH4+", None, ["N", "H"], 1.0180384599999999, 1.0, PhaseType.AQUEOUS)
    NO2_minus = Species("NO2-", None, ["N", "O"], 0.9539945, -1.0, PhaseType.AQUEOUS)
    NO3_minus = Species("NO3-", None, ["N", "O"], 0.9379951, -1.0, PhaseType.AQUEOUS)
    Na_plus = Species("Na+", None, ["Na"], 1.02298977, 1.0, PhaseType.AQUEOUS)
    ...
    Nd_plus2 = Species("Nd+2", None, ["Nd"], 2.14424, 2.0, PhaseType.AQUEOUS)
    Nd_plus3 = Species("Nd+3", None, ["Nd"], 3.14424, 3.0, PhaseType.AQUEOUS)
    Nd_plus4 = Species("Nd+4", None, ["Nd"], 4.14424, 4.0, PhaseType.AQUEOUS)
    Ne_aq = Species("Ne(aq)", None, ["Ne"], 0.0201797, 0.0, PhaseType.AQUEOUS)
    Ni_plus2 = Species("Ni+2", None, ["Ni"], 2.0586934, 2.0, PhaseType.AQUEOUS)
    NiCl_plus = Species("NiCl+", None, ["Ni", "Cl"], 1.0941463999999999, 1.0, PhaseType.AQUEOUS)
    NiOH_plus = Species("NiOH+", None, ["Ni", "O", "H"], 1.07570074, 1.0, PhaseType.AQUEOUS)
    NiO_aq = Species("NiO(aq)", None, ["Ni", "O"], 0.0746928, 0.0, PhaseType.AQUEOUS)
    HNiO2_minus = Species("HNiO2-", None, ["H", "Ni", "O"], 0.90829986, -1.0, PhaseType.AQUEOUS)
    NiO2_minus2 = Species("NiO2-2", None, ["Ni", "O"], 1.9093078, -2.0, PhaseType.AQUEOUS)
    O2_aq = Species("O2(aq)", None, ["O"], 0.0319988, 0.0, PhaseType.AQUEOUS)
    OH_minus = Species("OH-", None, ["O", "H"], 0.98299266, -1.0, PhaseType.AQUEOUS)
    PO4_minus3 = Species("PO4-3", None, ["P", "O"], 2.905028639, -3.0, PhaseType.AQUEOUS)
    Pb_plus2 = Species("Pb+2", None, ["Pb"], 2.2072, 2.0, PhaseType.AQUEOUS)
    PbCl_plus = Species("PbCl+", None, ["Pb", "Cl"], 1.242653, 1.0, PhaseType.AQUEOUS)
    PbCl2_aq = Species("PbCl2(aq)", None, ["Pb", "Cl"], 0.27810599999999996, 0.0, PhaseType.AQUEOUS)
    PbCl3_minus = Species("PbCl3-", None, ["Pb", "Cl"], 0.686441, -1.0, PhaseType.AQUEOUS)
    PbCl4_minus2 = Species("PbCl4-2", None, ["Pb", "Cl"], 1.650988, -2.0, PhaseType.AQUEOUS)
    PbOH_plus = Species("PbOH+", None, ["Pb", "O", "H"], 1.2242073400000002, 1.0, PhaseType.AQUEOUS)
    PbO_aq = Species("PbO(aq)", None, ["Pb", "O"], 0.2231994, 0.0, PhaseType.AQUEOUS)
    HPbO2_minus = Species("HPbO2-", None, ["H", "Pb", "O"], 0.7597932599999999, -1.0, PhaseType.AQUEOUS)
    Pd_OH_plus = Species("Pd(OH)+", None, ["Pd", "O", "H"], 1.12342734, 1.0, PhaseType.AQUEOUS)
    PdSO4_aq = Species("PdSO4(aq)", None, ["Pd", "S", "O"], 0.2024826, 0.0, PhaseType.AQUEOUS)
    Pd_SO4_2_minus2 = Species("Pd(SO4)2-2", None, ["Pd", "S", "O"], 1.7014548, -2.0, PhaseType.AQUEOUS)
    Pd_SO4_3_minus4 = Species("Pd(SO4)3-4", None, ["Pd", "S", "O"], 3.6053922000000003, -4.0, PhaseType.AQUEOUS)
    Pd_plus2 = Species("Pd+2", None, ["Pd"], 2.10642, 2.0, PhaseType.AQUEOUS)
    PdCl_plus = Species("PdCl+", None, ["Pd", "Cl"], 1.141873, 1.0, PhaseType.AQUEOUS)
    PdCl2_aq = Species("PdCl2(aq)", None, ["Pd", "Cl"], 0.17732599999999998, 0.0, PhaseType.AQUEOUS)
    PdCl3_minus = Species("PdCl3-", None, ["Pd", "Cl"], 0.7872210000000001, -1.0, PhaseType.AQUEOUS)
    PdCl4_minus2 = Species("PdCl4-2", None, ["Pd", "Cl"], 1.751768, -2.0, PhaseType.AQUEOUS)
    PdO_aq = Species("PdO(aq)", None, ["Pd", "O"], 0.1224194, 0.0, PhaseType.AQUEOUS)
    Pr_plus2 = Species("Pr+2", None, ["Pr"], 2.14090765, 2.0, PhaseType.AQUEOUS)
    Pr_plus3 = Species("Pr+3", None, ["Pr"], 3.14090765, 3.0, PhaseType.AQUEOUS)
    Pr_plus4 = Species("Pr+4", None, ["Pr"], 4.14090765, 4.0, PhaseType.AQUEOUS)
    Pt_OH_plus = Species("Pt(OH)+", None, ["Pt", "O", "H"], 1.2120853400000002, 1.0, PhaseType.AQUEOUS)
    PtSO4_aq = Species("PtSO4(aq)", None, ["Pt", "S", "O"], 0.2911406, 0.0, PhaseType.AQUEOUS)
    Pt_SO4_2_minus2 = Species("Pt(SO4)2-2", None, ["Pt", "S", "O"], 1.6127968, -2.0, PhaseType.AQUEOUS)
    Pt_SO4_3_minus4 = Species("Pt(SO4)3-4", None, ["Pt", "S", "O"], 3.5167342, -4.0, PhaseType.AQUEOUS)
    Pt_plus2 = Species("Pt+2", None, ["Pt"], 2.195078, 2.0, PhaseType.AQUEOUS)
    PtCl_plus = Species("PtCl+", None, ["Pt", "Cl"], 1.230531, 1.0, PhaseType.AQUEOUS)
    PtCl2_aq = Species("PtCl2(aq)", None, ["Pt", "Cl"], 0.265984, 0.0, PhaseType.AQUEOUS)
    PtCl3_minus = Species("PtCl3-", None, ["Pt", "Cl"], 0.698563, -1.0, PhaseType.AQUEOUS)
    PtCl4_minus2 = Species("PtCl4-2", None, ["Pt", "Cl"], 1.6631099999999999, -2.0, PhaseType.AQUEOUS)
    PtO_aq = Species("PtO(aq)", None, ["Pt", "O"], 0.2110774, 0.0, PhaseType.AQUEOUS)
    Ra_plus2 = Species("Ra+2", None, ["Ra"], 2.226, 2.0, PhaseType.AQUEOUS)
    Rb_plus = Species("Rb+", None, ["Rb"], 1.0854678, 1.0, PhaseType.AQUEOUS)
    ...
    ReO4_minus = Species("ReO4-", None, ["Re", "O"], 0.7497954, -1.0, PhaseType.AQUEOUS)
    Rh_OH_plus = Species("Rh(OH)+", None, ["Rh", "O", "H"], 1.1199128400000002, 1.0, PhaseType.AQUEOUS)
    Rh_OH_plus2 = Species("Rh(OH)+2", None, ["Rh", "O", "H"], 2.11991284, 2.0, PhaseType.AQUEOUS)
    RhSO4_aq = Species("RhSO4(aq)", None, ["Rh", "S", "O"], 0.19896809999999998, 0.0, PhaseType.AQUEOUS)
    Rh_SO4_plus = Species("Rh(SO4)+", None, ["Rh", "S", "O"], 1.1989681, 1.0, PhaseType.AQUEOUS)
    Rh_SO4_2_minus = Species("Rh(SO4)2-", None, ["Rh", "S", "O"], 0.7049693, -1.0, PhaseType.AQUEOUS)
    Rh_SO4_2_minus2 = Species("Rh(SO4)2-2", None, ["Rh", "S", "O"], 1.7049693, -2.0, PhaseType.AQUEOUS)
    Rh_SO4_3_minus3 = Species("Rh(SO4)3-3", None, ["Rh", "S", "O"], 2.6089067000000004, -3.0, PhaseType.AQUEOUS)
    Rh_SO4_3_minus4 = Species("Rh(SO4)3-4", None, ["Rh", "S", "O"], 3.6089067000000004, -4.0, PhaseType.AQUEOUS)
    Rh_plus2 = Species("Rh+2", None, ["Rh"], 2.1029055, 2.0, PhaseType.AQUEOUS)
    Rh_plus3 = Species("Rh+3", None, ["Rh"], 3.1029055, 3.0, PhaseType.AQUEOUS)
    RhCl_plus = Species("RhCl+", None, ["Rh", "Cl"], 1.1383585, 1.0, PhaseType.AQUEOUS)
    RhCl_plus2 = Species("RhCl+2", None, ["Rh", "Cl"], 2.1383585, 2.0, PhaseType.AQUEOUS)
    RhCl2_aq = Species("RhCl2(aq)", None, ["Rh", "Cl"], 0.1738115, 0.0, PhaseType.AQUEOUS)
    RhCl2_plus = Species("RhCl2+", None, ["Rh", "Cl"], 1.1738115, 1.0, PhaseType.AQUEOUS)
    RhCl3_aq = Species("RhCl3(aq)", None, ["Rh", "Cl"], 0.2092645, 0.0, PhaseType.AQUEOUS)
    RhCl3_minus = Species("RhCl3-", None, ["Rh", "Cl"], 0.7907355, -1.0, PhaseType.AQUEOUS)
    RhCl4_minus = Species("RhCl4-", None, ["Rh", "Cl"], 0.7552825000000001, -1.0, PhaseType.AQUEOUS)
    RhCl4_minus2 = Species("RhCl4-2", None, ["Rh", "Cl"], 1.7552824999999999, -2.0, PhaseType.AQUEOUS)
    RhO_aq = Species("RhO(aq)", None, ["Rh", "O"], 0.1189049, 0.0, PhaseType.AQUEOUS)
    RhO_plus = Species("RhO+", None, ["Rh", "O"], 1.1189049000000002, 1.0, PhaseType.AQUEOUS)
    Rn_aq = Species("Rn(aq)", None, ["Rn"], 0.222, 0.0, PhaseType.AQUEOUS)
    Ru_OH_plus = Species("Ru(OH)+", None, ["Ru", "O", "H"], 1.1180773400000001, 1.0, PhaseType.AQUEOUS)
    Ru_OH_plus2 = Species("Ru(OH)+2", None, ["Ru", "O", "H"], 2.11807734, 2.0, PhaseType.AQUEOUS)
    RuO4_minus2 = Species("RuO4-2", None, ["Ru", "O"], 1.8349324, -2.0, PhaseType.AQUEOUS)
    RuSO4_aq = Species("RuSO4(aq)", None, ["Ru", "S", "O"], 0.1971326, 0.0, PhaseType.AQUEOUS)
    Ru_SO4_plus = Species("Ru(SO4)+", None, ["Ru", "S", "O"], 1.1971326, 1.0, PhaseType.AQUEOUS)
    Ru_SO4_2_minus = Species("Ru(SO4)2-", None, ["Ru", "S", "O"], 0.7068048, -1.0, PhaseType.AQUEOUS)
    Ru_SO4_2_minus2 = Species("Ru(SO4)2-2", None, ["Ru", "S", "O"], 1.7068048, -2.0, PhaseType.AQUEOUS)
    Ru_SO4_3_minus3 = Species("Ru(SO4)3-3", None, ["Ru", "S", "O"], 2.6107422000000002, -3.0, PhaseType.AQUEOUS)
    Ru_SO4_3_minus4 = Species("Ru(SO4)3-4", None, ["Ru", "S", "O"], 3.6107422000000002, -4.0, PhaseType.AQUEOUS)
    Ru_plus2 = Species("Ru+2", None, ["Ru"], 2.10107, 2.0, PhaseType.AQUEOUS)
    Ru_plus3 = Species("Ru+3", None, ["Ru"], 3.10107, 3.0, PhaseType.AQUEOUS)
    RuCl_plus = Species("RuCl+", None, ["Ru", "Cl"], 1.136523, 1.0, PhaseType.AQUEOUS)
    RuCl_plus2 = Species("RuCl+2", None, ["Ru", "Cl"], 2.136523, 2.0, PhaseType.AQUEOUS)
    RuCl2_aq = Species("RuCl2(aq)", None, ["Ru", "Cl"], 0.171976, 0.0, PhaseType.AQUEOUS)
    RuCl2_plus = Species("RuCl2+", None, ["Ru", "Cl"], 1.171976, 1.0, PhaseType.AQUEOUS)
    RuCl3_aq = Species("RuCl3(aq)", None, ["Ru", "Cl"], 0.20742899999999997, 0.0, PhaseType.AQUEOUS)
    RuCl3_minus = Species("RuCl3-", None, ["Ru", "Cl"], 0.792571, -1.0, PhaseType.AQUEOUS)
    RuCl4_minus = Species("RuCl4-", None, ["Ru", "Cl"], 0.757118, -1.0, PhaseType.AQUEOUS)
    RuCl4_minus2 = Species("RuCl4-2", None, ["Ru", "Cl"], 1.757118, -2.0, PhaseType.AQUEOUS)
    RuCl5_minus2 = Species("RuCl5-2", None, ["Ru", "Cl"], 1.721665, -2.0, PhaseType.AQUEOUS)
    RuCl6_minus3 = Species("RuCl6-3", None, ["Ru", "Cl"], 2.686212, -3.0, PhaseType.AQUEOUS)
    RuO_aq = Species("RuO(aq)", None, ["Ru", "O"], 0.11706939999999999, 0.0, PhaseType.AQUEOUS)
    RuO_plus = Species("RuO+", None, ["Ru", "O"], 1.1170694, 1.0, PhaseType.AQUEOUS)
    S2_minus2 = Species("S2-2", None, ["S"], 1.93587, -2.0, PhaseType.AQUEOUS)
    S2O3_minus2 = Species("S2O3-2", None, ["S", "O"], 1.8878717999999999, -2.0, PhaseType.AQUEOUS)
    HS2O3_minus = Species("HS2O3-", None, ["H", "S", "O"], 0.88686386, -1.0, PhaseType.AQUEOUS)
    H2S2O3_aq = Species("H2S2O3(aq)", None, ["H", "S", "O"], 0.11414408000000001, 0.0, PhaseType.AQUEOUS)
    S2O4_minus2 = Species("S2O4-2", None, ["S", "O"], 1.8718724, -2.0, PhaseType.AQUEOUS)
    HS2O4_minus = Species("HS2O4-", None, ["H", "S", "O"], 0.87086446, -1.0, PhaseType.AQUEOUS)
    H2S2O4_aq = Species("H2S2O4(aq)", None, ["H", "S", "O"], 0.13014348, 0.0, PhaseType.AQUEOUS)
    S2O5_minus2 = Species("S2O5-2", None, ["S", "O"], 1.8558729999999999, -2.0, PhaseType.AQUEOUS)
    S2O6_minus2 = Species("S2O6-2", None, ["S", "O"], 1.8398736, -2.0, PhaseType.AQUEOUS)
    S2O8_minus2 = Species("S2O8-2", None, ["S", "O"], 1.8078748, -2.0, PhaseType.AQUEOUS)
    S3_minus2 = Species("S3-2", None, ["S"], 1.903805, -2.0, PhaseType.AQUEOUS)
    S3O6_minus2 = Species("S3O6-2", None, ["S", "O"], 1.8078086, -2.0, PhaseType.AQUEOUS)
    S4_minus2 = Species("S4-2", None, ["S"], 1.87174, -2.0, PhaseType.AQUEOUS)
    S4O6_minus2 = Species("S4O6-2", None, ["S", "O"], 1.7757436, -2.0, PhaseType.AQUEOUS)
    S5_minus2 = Species("S5-2", None, ["S"], 1.839675, -2.0, PhaseType.AQUEOUS)
    S5O6_minus2 = Species("S5O6-2", None, ["S", "O"], 1.7436786, -2.0, PhaseType.AQUEOUS)
    SO2_aq = Species("SO2(aq)", None, ["S", "O"], 0.0640638, 0.0, PhaseType.AQUEOUS)
    SO3_minus2 = Species("SO3-2", None, ["S", "O"], 1.9199367999999999, -2.0, PhaseType.AQUEOUS)
    SO4_minus2 = Species("SO4-2", None, ["S", "O"], 1.9039374, -2.0, PhaseType.AQUEOUS)
    Sc_plus3 = Species("Sc+3", None, ["Sc"], 3.04495591, 3.0, PhaseType.AQUEOUS)
    ScOH_plus2 = Species("ScOH+2", None, ["Sc", "O", "H"], 2.0619632500000002, 2.0, PhaseType.AQUEOUS)
    ScO_plus = Species("ScO+", None, ["Sc", "O"], 1.0609553100000002, 1.0, PhaseType.AQUEOUS)
    HScO2_aq = Species("HScO2(aq)", None, ["H", "Sc", "O"], 0.07796265, 0.0, PhaseType.AQUEOUS)
    ScO2_minus = Species("ScO2-", None, ["Sc", "O"], 0.92304529, -1.0, PhaseType.AQUEOUS)
    SeO3_minus2 = Species("SeO3-2", None, ["Se", "O"], 1.8730418, -2.0, PhaseType.AQUEOUS)
    SeO4_minus2 = Species("SeO4-2", None, ["Se", "O"], 1.8570424, -2.0, PhaseType.AQUEOUS)
    SiF6_minus2 = Species("SiF6-2", None, ["Si", "F"], 1.857924082, -2.0, PhaseType.AQUEOUS)
    SiO2_aq = Species("SiO2(aq)", None, ["Si", "O"], 0.0600843, 0.0, PhaseType.AQUEOUS)
    Sm_plus2 = Species("Sm+2", None, ["Sm"], 2.15036, 2.0, PhaseType.AQUEOUS)
    Sm_plus3 = Species("Sm+3", None, ["Sm"], 3.15036, 3.0, PhaseType.AQUEOUS)
    Sm_plus4 = Species("Sm+4", None, ["Sm"], 4.15036, 4.0, PhaseType.AQUEOUS)
    Sn_plus2 = Species("Sn+2", None, ["Sn"], 2.11871, 2.0, PhaseType.AQUEOUS)
    SnO_aq = Species("SnO(aq)", None, ["Sn", "O"], 0.1347094, 0.0, PhaseType.AQUEOUS)
    SnOH_plus = Species("SnOH+", None, ["Sn", "O", "H"], 1.1357173400000002, 1.0, PhaseType.AQUEOUS)
    HSnO2_minus = Species("HSnO2-", None, ["H", "Sn", "O"], 0.84828326, -1.0, PhaseType.AQUEOUS)
    Sr_HCO3_plus = Species("Sr(HCO3)+", None, ["Sr", "H", "C", "O"], 1.1486368400000002, 1.0, PhaseType.AQUEOUS)
    Sr_plus2 = Species("Sr+2", None, ["Sr"], 2.08762, 2.0, PhaseType.AQUEOUS)
    SrCl_plus = Species("SrCl+", None, ["Sr", "Cl"], 1.123073, 1.0, PhaseType.AQUEOUS)
    SrF_plus = Species("SrF+", None, ["Sr", "F"], 1.1066184030000001, 1.0, PhaseType.AQUEOUS)
    SrOH_plus = Species("SrOH+", None, ["Sr", "O", "H"], 1.1046273400000002, 1.0, PhaseType.AQUEOUS)
    Tb_plus2 = Species("Tb+2", None, ["Tb"], 2.15892534, 2.0, PhaseType.AQUEOUS)
    Tb_plus3 = Species("Tb+3", None, ["Tb"], 3.15892534, 3.0, PhaseType.AQUEOUS)
    Tb_plus4 = Species("Tb+4", None, ["Tb"], 4.15892534, 4.0, PhaseType.AQUEOUS)
    Th_plus4 = Species("Th+4", None, ["Th"], 4.2320381, 4.0, PhaseType.AQUEOUS)
    Tl_plus = Species("Tl+", None, ["Tl"], 1.2043833, 1.0, PhaseType.AQUEOUS)
    Tl_plus3 = Species("Tl+3", None, ["Tl"], 3.2043833, 3.0, PhaseType.AQUEOUS)
    TlOH_aq = Species("TlOH(aq)", None, ["Tl", "O", "H"], 0.22139064, 0.0, PhaseType.AQUEOUS)
    TlOH_plus2 = Species("TlOH+2", None, ["Tl", "O", "H"], 2.22139064, 2.0, PhaseType.AQUEOUS)
    TlO_plus = Species("TlO+", None, ["Tl", "O"], 1.2203827, 1.0, PhaseType.AQUEOUS)
    HTlO2_aq = Species("HTlO2(aq)", None, ["H", "Tl", "O"], 0.23739004, 0.0, PhaseType.AQUEOUS)
    TlO2_minus = Species("TlO2-", None, ["Tl", "O"], 0.7636179000000001, -1.0, PhaseType.AQUEOUS)
    Tm_plus2 = Species("Tm+2", None, ["Tm"], 2.16893421, 2.0, PhaseType.AQUEOUS)
    Tm_plus3 = Species("Tm+3", None, ["Tm"], 3.16893421, 3.0, PhaseType.AQUEOUS)
    Tm_plus4 = Species("Tm+4", None, ["Tm"], 4.16893421, 4.0, PhaseType.AQUEOUS)
    U_plus3 = Species("U+3", None, ["U"], 3.23802891, 3.0, PhaseType.AQUEOUS)
    U_plus4 = Species("U+4", None, ["U"], 4.23802891, 4.0, PhaseType.AQUEOUS)
    UO2_plus = Species("UO2+", None, ["U", "O"], 1.27002771, 1.0, PhaseType.AQUEOUS)
    UO2_plus2 = Species("UO2+2", None, ["U", "O"], 2.2700277100000004, 2.0, PhaseType.AQUEOUS)
    VO_plus = Species("VO+", None, ["V", "O"], 1.0669409, 1.0, PhaseType.AQUEOUS)
    VO_plus2 = Species("VO+2", None, ["V", "O"], 2.0669409, 2.0, PhaseType.AQUEOUS)
    VOH_plus = Species("VOH+", None, ["V", "O", "H"], 1.0679488400000001, 1.0, PhaseType.AQUEOUS)
    VOH_plus2 = Species("VOH+2", None, ["V", "O", "H"], 2.06794884, 2.0, PhaseType.AQUEOUS)
    VO2_plus = Species("VO2+", None, ["V", "O"], 1.0829403, 1.0, PhaseType.AQUEOUS)
    Vooh_plus = Species("Vooh+", None, ["V", "O", "H"], 1.08394824, 1.0, PhaseType.AQUEOUS)
    WO4_minus2 = Species("WO4-2", None, ["W", "O"], 1.7521624, -2.0, PhaseType.AQUEOUS)
    HWO4_minus = Species("HWO4-", None, ["H", "W", "O"], 0.75115446, -1.0, PhaseType.AQUEOUS)
    Xe_aq = Species("Xe(aq)", None, ["Xe"], 0.131293, 0.0, PhaseType.AQUEOUS)
    Y_plus3 = Species("Y+3", None, ["Y"], 3.08890585, 3.0, PhaseType.AQUEOUS)
    YOH_plus2 = Species("YOH+2", None, ["Y", "O", "H"], 2.1059131900000003, 2.0, PhaseType.AQUEOUS)
    YO_plus = Species("YO+", None, ["Y", "O"], 1.10490525, 1.0, PhaseType.AQUEOUS)
    HYO2_aq = Species("HYO2(aq)", None, ["H", "Y", "O"], 0.12191258999999999, 0.0, PhaseType.AQUEOUS)
    YO2_minus = Species("YO2-", None, ["Y", "O"], 0.87909535, -1.0, PhaseType.AQUEOUS)
    Yb_plus2 = Species("Yb+2", None, ["Yb"], 2.17304, 2.0, PhaseType.AQUEOUS)
    Yb_plus3 = Species("Yb+3", None, ["Yb"], 3.17304, 3.0, PhaseType.AQUEOUS)
    Yb_plus4 = Species("Yb+4", None, ["Yb"], 4.17304, 4.0, PhaseType.AQUEOUS)
    Zn_plus2 = Species("Zn+2", None, ["Zn"], 2.065409, 2.0, PhaseType.AQUEOUS)
    ZnCl_plus = Species("ZnCl+", None, ["Zn", "Cl"], 1.100862, 1.0, PhaseType.AQUEOUS)
    ZnCl2_aq = Species("ZnCl2(aq)", None, ["Zn", "Cl"], 0.136315, 0.0, PhaseType.AQUEOUS)
    ZnCl3_minus = Species("ZnCl3-", None, ["Zn", "Cl"], 0.828232, -1.0, PhaseType.AQUEOUS)
    ZnOH_plus = Species("ZnOH+", None, ["Zn", "O", "H"], 1.0824163400000002, 1.0, PhaseType.AQUEOUS)
    ZnO_aq = Species("ZnO(aq)", None, ["Zn", "O"], 0.08140839999999999, 0.0, PhaseType.AQUEOUS)
    HZnO2_minus = Species("HZnO2-", None, ["H", "Zn", "O"], 0.9015842599999999, -1.0, PhaseType.AQUEOUS)
    ZnO2_minus2 = Species("ZnO2-2", None, ["Zn", "O"], 1.9025922, -2.0, PhaseType.AQUEOUS)
    U_OH_plus2 = Species("U(OH)+2", None, ["U", "O", "H"], 2.2550362500000003, 2.0, PhaseType.AQUEOUS)
    UO_plus = Species("UO+", None, ["U", "O"], 1.25402831, 1.0, PhaseType.AQUEOUS)
    HUO2_aq = Species("HUO2(aq)", None, ["U", "O", "H"], 0.27103565, 0.0, PhaseType.AQUEOUS)
    U_OH_plus3 = Species("U(OH)+3", None, ["U", "O", "H"], 3.2550362500000003, 3.0, PhaseType.AQUEOUS)
    UO_plus2 = Species("UO+2", None, ["U", "O"], 2.2540283100000003, 2.0, PhaseType.AQUEOUS)
    HUO2_plus = Species("HUO2+", None, ["U", "O", "H"], 1.27103565, 1.0, PhaseType.AQUEOUS)
    UO2_aq = Species("UO2(aq)", None, ["U", "O"], 0.27002771000000003, 0.0, PhaseType.AQUEOUS)
    HUO3_minus = Species("HUO3-", None, ["U", "O", "H"], 0.7129649499999999, -1.0, PhaseType.AQUEOUS)
    UO2OH_aq = Species("UO2OH(aq)", None, ["U", "O", "H"], 0.28703505, 0.0, PhaseType.AQUEOUS)
    UO3_minus = Species("UO3-", None, ["U", "O"], 0.71397289, -1.0, PhaseType.AQUEOUS)
    UO2OH_plus = Species("UO2OH+", None, ["U", "O", "H"], 1.28703505, 1.0, PhaseType.AQUEOUS)
    UO3_aq = Species("UO3(aq)", None, ["U", "O"], 0.28602711000000003, 0.0, PhaseType.AQUEOUS)
    HUO4_minus = Species("HUO4-", None, ["U", "O", "H"], 0.6969655499999999, -1.0, PhaseType.AQUEOUS)
    UO4_minus2 = Species("UO4-2", None, ["U", "O"], 1.69797349, -2.0, PhaseType.AQUEOUS)
    Fr_plus = Species("Fr+", None, ["Fr"], 1.223, 1.0, PhaseType.AQUEOUS)
    ...
    HN2O2_minus = Species("HN2O2-", None, ["H", "N", "O"], 0.93897986, -1.0, PhaseType.AQUEOUS)
    N2O2_minus2 = Species("N2O2-2", None, ["N", "O"], 1.9399878, -2.0, PhaseType.AQUEOUS)
    N2H5_plus = Species("N2H5+", None, ["N", "H"], 1.0330531, 1.0, PhaseType.AQUEOUS)
    N2H6_plus2 = Species("N2H6+2", None, ["N", "H"], 2.0340610399999997, 2.0, PhaseType.AQUEOUS)
    H3PO2_aq = Species("H3PO2(aq)", None, ["H", "P", "O"], 0.06599638099999999, 0.0, PhaseType.AQUEOUS)
    H2PO2_minus = Species("H2PO2-", None, ["H", "P", "O"], 0.935011559, -1.0, PhaseType.AQUEOUS)
    H3PO3_aq = Species("H3PO3(aq)", None, ["H", "P", "O"], 0.081995781, 0.0, PhaseType.AQUEOUS)
    H2PO3_minus = Species("H2PO3-", None, ["H", "P", "O"], 0.919012159, -1.0, PhaseType.AQUEOUS)
    HPO3_minus2 = Species("HPO3-2", None, ["H", "P", "O"], 1.9200200989999998, -2.0, PhaseType.AQUEOUS)
    P2O7_minus4 = Species("P2O7-4", None, ["P", "O"], 3.826056678, -4.0, PhaseType.AQUEOUS)
    HP2O7_minus3 = Species("HP2O7-3", None, ["H", "P", "O"], 2.825048738, -3.0, PhaseType.AQUEOUS)
    H4P2O7_aq = Species("H4P2O7(aq)", None, ["H", "P", "O"], 0.177975082, 0.0, PhaseType.AQUEOUS)
    AsO4_minus3 = Species("AsO4-3", None, ["As", "O"], 2.8610808, -3.0, PhaseType.AQUEOUS)
    H3AsO4_aq = Species("H3AsO4(aq)", None, ["H", "As", "O"], 0.14194302, 0.0, PhaseType.AQUEOUS)
    H2AsO4_minus = Species("H2AsO4-", None, ["H", "As", "O"], 0.85906492, -1.0, PhaseType.AQUEOUS)
    HAsO4_minus2 = Species("HAsO4-2", None, ["H", "As", "O"], 1.86007286, -2.0, PhaseType.AQUEOUS)
    HAsO2_aq = Species("HAsO2(aq)", None, ["H", "As", "O"], 0.10792834000000001, 0.0, PhaseType.AQUEOUS)
    H2AsO3_minus = Species("H2AsO3-", None, ["H", "As", "O"], 0.87506432, -1.0, PhaseType.AQUEOUS)
    HAsO3_minus2 = Species("HAsO3-2", None, ["H", "As", "O"], 1.87607226, -2.0, PhaseType.AQUEOUS)
    AsO3_minus3 = Species("AsO3-3", None, ["As", "O"], 2.8770802, -3.0, PhaseType.AQUEOUS)
    As3S4_HS_2_minus = Species("As3S4(HS)2-", None, ["As", "S", "H"], 0.58082932, -1.0, PhaseType.AQUEOUS)
    HSbO2_aq = Species("HSbO2(aq)", None, ["H", "Sb", "O"], 0.15476673999999999, 0.0, PhaseType.AQUEOUS)
    SbO2_minus = Species("SbO2-", None, ["Sb", "O"], 0.8462412, -1.0, PhaseType.AQUEOUS)
    Bi_plus3 = Species("Bi+3", None, ["Bi"], 3.20898038, 3.0, PhaseType.AQUEOUS)
    BiO_plus = Species("BiO+", None, ["Bi", "O"], 1.2249797800000002, 1.0, PhaseType.AQUEOUS)
    BiOH_plus2 = Species("BiOH+2", None, ["Bi", "O", "H"], 2.22598772, 2.0, PhaseType.AQUEOUS)
    HBiO2_aq = Species("HBiO2(aq)", None, ["H", "Bi", "O"], 0.24198712, 0.0, PhaseType.AQUEOUS)
    BiO2_minus = Species("BiO2-", None, ["Bi", "O"], 0.75902082, -1.0, PhaseType.AQUEOUS)
    ...
    V_plus2 = Species("V+2", None, ["V"], 2.0509415, 2.0, PhaseType.AQUEOUS)
    V_plus3 = Species("V+3", None, ["V"], 3.0509415, 3.0, PhaseType.AQUEOUS)
    VO4_minus3 = Species("VO4-3", None, ["V", "O"], 2.8850609, -3.0, PhaseType.AQUEOUS)
    Cr_plus2 = Species("Cr+2", None, ["Cr"], 2.0519961, 2.0, PhaseType.AQUEOUS)
    Cr_plus3 = Species("Cr+3", None, ["Cr"], 3.0519961, 3.0, PhaseType.AQUEOUS)
    CrOH_plus2 = Species("CrOH+2", None, ["Cr", "O", "H"], 2.0690034400000004, 2.0, PhaseType.AQUEOUS)
    CrO_plus = Species("CrO+", None, ["Cr", "O"], 1.0679955, 1.0, PhaseType.AQUEOUS)
    HCrO2_aq = Species("HCrO2(aq)", None, ["H", "Cr", "O"], 0.08500284, 0.0, PhaseType.AQUEOUS)
    CrO2_minus = Species("CrO2-", None, ["Cr", "O"], 0.9160051, -1.0, PhaseType.AQUEOUS)
    Zr_plus4 = Species("Zr+4", None, ["Zr"], 4.091224, 4.0, PhaseType.AQUEOUS)
    Zr_OH_plus3 = Species("Zr(OH)+3", None, ["Zr", "O", "H"], 3.10823134, 3.0, PhaseType.AQUEOUS)
    ZrO_plus2 = Species("ZrO+2", None, ["Zr", "O"], 2.1072234, 2.0, PhaseType.AQUEOUS)
    HZrO2_plus = Species("HZrO2+", None, ["Zr", "O", "H"], 1.12423074, 1.0, PhaseType.AQUEOUS)
    ZrO2_aq = Species("ZrO2(aq)", None, ["Zr", "O"], 0.1232228, 0.0, PhaseType.AQUEOUS)
    HZrO3_minus = Species("HZrO3-", None, ["Zr", "O", "H"], 0.85976986, -1.0, PhaseType.AQUEOUS)
    HNbO3_aq = Species("HNbO3(aq)", None, ["H", "Nb", "O"], 0.14191252, 0.0, PhaseType.AQUEOUS)
    NbO3_minus = Species("NbO3-", None, ["Nb", "O"], 0.85909542, -1.0, PhaseType.AQUEOUS)
    TcO4_minus = Species("TcO4-", None, ["Tc", "O"], 0.8380024, -1.0, PhaseType.AQUEOUS)
    Pm_plus2 = Species("Pm+2", None, ["Pm"], 2.145, 2.0, PhaseType.AQUEOUS)
    Pm_plus3 = Species("Pm+3", None, ["Pm"], 3.145, 3.0, PhaseType.AQUEOUS)
    Pm_plus4 = Species("Pm+4", None, ["Pm"], 4.145, 4.0, PhaseType.AQUEOUS)
    Hf_plus4 = Species("Hf+4", None, ["Hf"], 4.17849, 4.0, PhaseType.AQUEOUS)
    HfOH_plus3 = Species("HfOH+3", None, ["Hf", "O", "H"], 3.19549734, 3.0, PhaseType.AQUEOUS)
    HfO_plus2 = Species("HfO+2", None, ["Hf", "O"], 2.1944894, 2.0, PhaseType.AQUEOUS)
    HHfO2_plus = Species("HHfO2+", None, ["H", "Hf", "O"], 1.21149674, 1.0, PhaseType.AQUEOUS)
    HfO2_aq = Species("HfO2(aq)", None, ["Hf", "O"], 0.2104888, 0.0, PhaseType.AQUEOUS)
    HHfO3_minus = Species("HHfO3-", None, ["H", "Hf", "O"], 0.7725038599999999, -1.0, PhaseType.AQUEOUS)
    La_plus2 = Species("La+2", None, ["La"], 2.1389055, 2.0, PhaseType.AQUEOUS)
    LaCO3_plus = Species("LaCO3+", None, ["La", "C", "O"], 1.1989144, 1.0, PhaseType.AQUEOUS)
    LaHCO3_plus2 = Species("LaHCO3+2", None, ["La", "H", "C", "O"], 2.1999223399999996, 2.0, PhaseType.AQUEOUS)
    LaOH_plus2 = Species("LaOH+2", None, ["La", "O", "H"], 2.15591284, 2.0, PhaseType.AQUEOUS)
    LaO_plus = Species("LaO+", None, ["La", "O"], 1.1549049, 1.0, PhaseType.AQUEOUS)
    LaO2H_aq = Species("LaO2H(aq)", None, ["La", "O", "H"], 0.17191224, 0.0, PhaseType.AQUEOUS)
    LaO2_minus = Species("LaO2-", None, ["La", "O"], 0.8290957, -1.0, PhaseType.AQUEOUS)
    LaCl_plus2 = Species("LaCl+2", None, ["La", "Cl"], 2.1743585, 2.0, PhaseType.AQUEOUS)
    LaCl2_plus = Species("LaCl2+", None, ["La", "Cl"], 1.2098114999999998, 1.0, PhaseType.AQUEOUS)
    LaCl3_aq = Species("LaCl3(aq)", None, ["La", "Cl"], 0.2452645, 0.0, PhaseType.AQUEOUS)
    LaCl4_minus = Species("LaCl4-", None, ["La", "Cl"], 0.7192825, -1.0, PhaseType.AQUEOUS)
    LaNO3_plus2 = Species("LaNO3+2", None, ["La", "N", "O"], 2.2009103999999997, 2.0, PhaseType.AQUEOUS)
    LaF_plus2 = Species("LaF+2", None, ["La", "F"], 2.157903903, 2.0, PhaseType.AQUEOUS)
    LaF2_plus = Species("LaF2+", None, ["La", "F"], 1.176902306, 1.0, PhaseType.AQUEOUS)
    LaF3_aq = Species("LaF3(aq)", None, ["La", "F"], 0.195900709, 0.0, PhaseType.AQUEOUS)
    LaF4_minus = Species("LaF4-", None, ["La", "F"], 0.785100888, -1.0, PhaseType.AQUEOUS)
    LaH2PO4_plus2 = Species("LaH2PO4+2", None, ["La", "H", "P", "O"], 2.235892741, 2.0, PhaseType.AQUEOUS)
    LaSO4_plus = Species("LaSO4+", None, ["La", "S", "O"], 1.2349681, 1.0, PhaseType.AQUEOUS)
    CeCO3_plus = Species("CeCO3+", None, ["Ce", "C", "O"], 1.2001249, 1.0, PhaseType.AQUEOUS)
    CeHCO3_plus2 = Species("CeHCO3+2", None, ["Ce", "H", "C", "O"], 2.2011328399999996, 2.0, PhaseType.AQUEOUS)
    CeOH_plus2 = Species("CeOH+2", None, ["Ce", "O", "H"], 2.15712334, 2.0, PhaseType.AQUEOUS)
    CeO_plus = Species("CeO+", None, ["Ce", "O"], 1.1561154, 1.0, PhaseType.AQUEOUS)
    CeO2H_aq = Species("CeO2H(aq)", None, ["Ce", "O", "H"], 0.17312274, 0.0, PhaseType.AQUEOUS)
    CeO2_minus = Species("CeO2-", None, ["Ce", "O"], 0.8278852, -1.0, PhaseType.AQUEOUS)
    CeCl_plus2 = Species("CeCl+2", None, ["Ce", "Cl"], 2.175569, 2.0, PhaseType.AQUEOUS)
    CeCl2_plus = Species("CeCl2+", None, ["Ce", "Cl"], 1.2110219999999998, 1.0, PhaseType.AQUEOUS)
    CeCl3_aq = Species("CeCl3(aq)", None, ["Ce", "Cl"], 0.246475, 0.0, PhaseType.AQUEOUS)
    CeCl4_minus = Species("CeCl4-", None, ["Ce", "Cl"], 0.718072, -1.0, PhaseType.AQUEOUS)
    CeH2PO4_plus2 = Species("CeH2PO4+2", None, ["Ce", "H", "P", "O"], 2.237103241, 2.0, PhaseType.AQUEOUS)
    CeNO3_plus2 = Species("CeNO3+2", None, ["Ce", "N", "O"], 2.2021208999999997, 2.0, PhaseType.AQUEOUS)
    CeF_plus2 = Species("CeF+2", None, ["Ce", "F"], 2.159114403, 2.0, PhaseType.AQUEOUS)
    CeF2_plus = Species("CeF2+", None, ["Ce", "F"], 1.178112806, 1.0, PhaseType.AQUEOUS)
    CeF3_aq = Species("CeF3(aq)", None, ["Ce", "F"], 0.197111209, 0.0, PhaseType.AQUEOUS)
    CeF4_minus = Species("CeF4-", None, ["Ce", "F"], 0.783890388, -1.0, PhaseType.AQUEOUS)
    CeBr_plus2 = Species("CeBr+2", None, ["Ce", "Br"], 2.22002, 2.0, PhaseType.AQUEOUS)
    CeIO3_plus2 = Species("CeIO3+2", None, ["Ce", "I", "O"], 2.3150186699999997, 2.0, PhaseType.AQUEOUS)
    CeClO4_plus2 = Species("CeClO4+2", None, ["Ce", "Cl", "O"], 2.2395666, 2.0, PhaseType.AQUEOUS)
    CeSO4_plus = Species("CeSO4+", None, ["Ce", "S", "O"], 1.2361786, 1.0, PhaseType.AQUEOUS)
    PrCO3_plus = Species("PrCO3+", None, ["Pr", "C", "O"], 1.20091655, 1.0, PhaseType.AQUEOUS)
    PrHCO3_plus2 = Species("PrHCO3+2", None, ["Pr", "H", "C", "O"], 2.2019244899999997, 2.0, PhaseType.AQUEOUS)
    PrCl_plus2 = Species("PrCl+2", None, ["Pr", "Cl"], 2.17636065, 2.0, PhaseType.AQUEOUS)
    PrCl2_plus = Species("PrCl2+", None, ["Pr", "Cl"], 1.2118136499999999, 1.0, PhaseType.AQUEOUS)
    PrCl3_aq = Species("PrCl3(aq)", None, ["Pr", "Cl"], 0.24726664999999998, 0.0, PhaseType.AQUEOUS)
    PrCl4_minus = Species("PrCl4-", None, ["Pr", "Cl"], 0.71728035, -1.0, PhaseType.AQUEOUS)
    PrH2PO4_plus2 = Species("PrH2PO4+2", None, ["Pr", "H", "P", "O"], 2.237894891, 2.0, PhaseType.AQUEOUS)
    PrNO3_plus2 = Species("PrNO3+2", None, ["Pr", "N", "O"], 2.2029125499999997, 2.0, PhaseType.AQUEOUS)
    PrF_plus2 = Species("PrF+2", None, ["Pr", "F"], 2.159906053, 2.0, PhaseType.AQUEOUS)
    PrF2_plus = Species("PrF2+", None, ["Pr", "F"], 1.178904456, 1.0, PhaseType.AQUEOUS)
    PrF3_aq = Species("PrF3(aq)", None, ["Pr", "F"], 0.197902859, 0.0, PhaseType.AQUEOUS)
    PrF4_minus = Species("PrF4-", None, ["Pr", "F"], 0.7830987380000001, -1.0, PhaseType.AQUEOUS)
    PrOH_plus2 = Species("PrOH+2", None, ["Pr", "O", "H"], 2.15791499, 2.0, PhaseType.AQUEOUS)
    PrO_plus = Species("PrO+", None, ["Pr", "O"], 1.15690705, 1.0, PhaseType.AQUEOUS)
    PrO2H_aq = Species("PrO2H(aq)", None, ["Pr", "O", "H"], 0.17391439, 0.0, PhaseType.AQUEOUS)
    PrO2_minus = Species("PrO2-", None, ["Pr", "O"], 0.8270935500000001, -1.0, PhaseType.AQUEOUS)
    PrSO4_plus = Species("PrSO4+", None, ["Pr", "S", "O"], 1.23697025, 1.0, PhaseType.AQUEOUS)
    NdCO3_plus = Species("NdCO3+", None, ["Nd", "C", "O"], 1.2042489, 1.0, PhaseType.AQUEOUS)
    NdHCO3_plus2 = Species("NdHCO3+2", None, ["Nd", "H", "C", "O"], 2.2052568399999997, 2.0, PhaseType.AQUEOUS)
    NdOH_plus2 = Species("NdOH+2", None, ["Nd", "O", "H"], 2.16124734, 2.0, PhaseType.AQUEOUS)
    NdO_plus = Species("NdO+", None, ["Nd", "O"], 1.1602394, 1.0, PhaseType.AQUEOUS)
    NdO2H_aq = Species("NdO2H(aq)", None, ["Nd", "O", "H"], 0.17724674, 0.0, PhaseType.AQUEOUS)
    NdO2_minus = Species("NdO2-", None, ["Nd", "O"], 0.8237612, -1.0, PhaseType.AQUEOUS)
    NdCl_plus2 = Species("NdCl+2", None, ["Nd", "Cl"], 2.179693, 2.0, PhaseType.AQUEOUS)
    NdCl2_plus = Species("NdCl2+", None, ["Nd", "Cl"], 1.2151459999999998, 1.0, PhaseType.AQUEOUS)
    NdCl3_aq = Species("NdCl3(aq)", None, ["Nd", "Cl"], 0.250599, 0.0, PhaseType.AQUEOUS)
    NdCl4_minus = Species("NdCl4-", None, ["Nd", "Cl"], 0.713948, -1.0, PhaseType.AQUEOUS)
    NdH2PO4_plus2 = Species("NdH2PO4+2", None, ["Nd", "H", "P", "O"], 2.241227241, 2.0, PhaseType.AQUEOUS)
    NdNO3_plus2 = Species("NdNO3+2", None, ["Nd", "N", "O"], 2.2062448999999997, 2.0, PhaseType.AQUEOUS)
    NdF_plus2 = Species("NdF+2", None, ["Nd", "F"], 2.163238403, 2.0, PhaseType.AQUEOUS)
    NdF2_plus = Species("NdF2+", None, ["Nd", "F"], 1.182236806, 1.0, PhaseType.AQUEOUS)
    NdF3_aq = Species("NdF3(aq)", None, ["Nd", "F"], 0.20123520900000003, 0.0, PhaseType.AQUEOUS)
    NdF4_minus = Species("NdF4-", None, ["Nd", "F"], 0.779766388, -1.0, PhaseType.AQUEOUS)
    NdSO4_plus = Species("NdSO4+", None, ["Nd", "S", "O"], 1.2403026, 1.0, PhaseType.AQUEOUS)
    SmCO3_plus = Species("SmCO3+", None, ["Sm", "C", "O"], 1.2103689000000002, 1.0, PhaseType.AQUEOUS)
    SmOH_plus2 = Species("SmOH+2", None, ["Sm", "O", "H"], 2.16736734, 2.0, PhaseType.AQUEOUS)
    SmO_plus = Species("SmO+", None, ["Sm", "O"], 1.1663594000000002, 1.0, PhaseType.AQUEOUS)
    SmO2H_aq = Species("SmO2H(aq)", None, ["Sm", "O", "H"], 0.18336674, 0.0, PhaseType.AQUEOUS)
    SmO2_minus = Species("SmO2-", None, ["Sm", "O"], 0.8176412, -1.0, PhaseType.AQUEOUS)
    SmHCO3_plus2 = Species("SmHCO3+2", None, ["Sm", "H", "C", "O"], 2.21137684, 2.0, PhaseType.AQUEOUS)
    SmCl_plus2 = Species("SmCl+2", None, ["Sm", "Cl"], 2.185813, 2.0, PhaseType.AQUEOUS)
    SmCl2_plus = Species("SmCl2+", None, ["Sm", "Cl"], 1.221266, 1.0, PhaseType.AQUEOUS)
    SmCl3_aq = Species("SmCl3(aq)", None, ["Sm", "Cl"], 0.256719, 0.0, PhaseType.AQUEOUS)
    SmCl4_minus = Species("SmCl4-", None, ["Sm", "Cl"], 0.7078279999999999, -1.0, PhaseType.AQUEOUS)
    SmH2PO4_plus2 = Species("SmH2PO4+2", None, ["Sm", "H", "P", "O"], 2.247347241, 2.0, PhaseType.AQUEOUS)
    SmNO3_plus2 = Species("SmNO3+2", None, ["Sm", "N", "O"], 2.2123649, 2.0, PhaseType.AQUEOUS)
    SmF_plus2 = Species("SmF+2", None, ["Sm", "F"], 2.169358403, 2.0, PhaseType.AQUEOUS)
    SmF2_plus = Species("SmF2+", None, ["Sm", "F"], 1.188356806, 1.0, PhaseType.AQUEOUS)
    SmF3_aq = Species("SmF3(aq)", None, ["Sm", "F"], 0.20735520899999998, 0.0, PhaseType.AQUEOUS)
    SmF4_minus = Species("SmF4-", None, ["Sm", "F"], 0.773646388, -1.0, PhaseType.AQUEOUS)
    SmSO4_plus = Species("SmSO4+", None, ["Sm", "S", "O"], 1.2464226, 1.0, PhaseType.AQUEOUS)
    EuCO3_plus = Species("EuCO3+", None, ["Eu", "C", "O"], 1.2119729000000001, 1.0, PhaseType.AQUEOUS)
    EuOH_plus2 = Species("EuOH+2", None, ["Eu", "O", "H"], 2.16897134, 2.0, PhaseType.AQUEOUS)
    EuO_plus = Species("EuO+", None, ["Eu", "O"], 1.1679634, 1.0, PhaseType.AQUEOUS)
    EuO2H_aq = Species("EuO2H(aq)", None, ["Eu", "O", "H"], 0.18497074, 0.0, PhaseType.AQUEOUS)
    EuO2_minus = Species("EuO2-", None, ["Eu", "O"], 0.8160372, -1.0, PhaseType.AQUEOUS)
    EuHCO3_plus2 = Species("EuHCO3+2", None, ["Eu", "H", "C", "O"], 2.2129808399999997, 2.0, PhaseType.AQUEOUS)
    EuCl_plus2 = Species("EuCl+2", None, ["Eu", "Cl"], 2.187417, 2.0, PhaseType.AQUEOUS)
    EuCl2_plus = Species("EuCl2+", None, ["Eu", "Cl"], 1.22287, 1.0, PhaseType.AQUEOUS)
    EuCl3_aq = Species("EuCl3(aq)", None, ["Eu", "Cl"], 0.25832299999999997, 0.0, PhaseType.AQUEOUS)
    EuCl4_minus = Species("EuCl4-", None, ["Eu", "Cl"], 0.706224, -1.0, PhaseType.AQUEOUS)
    EuF_plus = Species("EuF+", None, ["Eu", "F"], 1.170962403, 1.0, PhaseType.AQUEOUS)
    EuF2_aq = Species("EuF2(aq)", None, ["Eu", "F"], 0.18996080599999998, 0.0, PhaseType.AQUEOUS)
    EuF3_minus = Species("EuF3-", None, ["Eu", "F"], 0.791040791, -1.0, PhaseType.AQUEOUS)
    EuF4_minus2 = Species("EuF4-2", None, ["Eu", "F"], 1.772042388, -2.0, PhaseType.AQUEOUS)
    EuCl_plus = Species("EuCl+", None, ["Eu", "Cl"], 1.187417, 1.0, PhaseType.AQUEOUS)
    EuCl2_aq = Species("EuCl2(aq)", None, ["Eu", "Cl"], 0.22286999999999998, 0.0, PhaseType.AQUEOUS)
    EuCl3_minus = Species("EuCl3-", None, ["Eu", "Cl"], 0.741677, -1.0, PhaseType.AQUEOUS)
    EuCl4_minus2 = Species("EuCl4-2", None, ["Eu", "Cl"], 1.706224, -2.0, PhaseType.AQUEOUS)
    EuH2PO4_plus2 = Species("EuH2PO4+2", None, ["Eu", "H", "P", "O"], 2.248951241, 2.0, PhaseType.AQUEOUS)
    EuNO3_plus2 = Species("EuNO3+2", None, ["Eu", "N", "O"], 2.2139689, 2.0, PhaseType.AQUEOUS)
    EuF_plus2 = Species("EuF+2", None, ["Eu", "F"], 2.170962403, 2.0, PhaseType.AQUEOUS)
    EuF2_plus = Species("EuF2+", None, ["Eu", "F"], 1.189960806, 1.0, PhaseType.AQUEOUS)
    EuF3_aq = Species("EuF3(aq)", None, ["Eu", "F"], 0.20895920899999998, 0.0, PhaseType.AQUEOUS)
    EuF4_minus = Species("EuF4-", None, ["Eu", "F"], 0.772042388, -1.0, PhaseType.AQUEOUS)
    EuSO4_plus = Species("EuSO4+", None, ["Eu", "S", "O"], 1.2480266, 1.0, PhaseType.AQUEOUS)
    GdCO3_plus = Species("GdCO3+", None, ["Gd", "C", "O"], 1.2172589, 1.0, PhaseType.AQUEOUS)
    GdOH_plus2 = Species("GdOH+2", None, ["Gd", "O", "H"], 2.17425734, 2.0, PhaseType.AQUEOUS)
    GdO_plus = Species("GdO+", None, ["Gd", "O"], 1.1732494, 1.0, PhaseType.AQUEOUS)
    GdO2H_aq = Species("GdO2H(aq)", None, ["Gd", "O", "H"], 0.19025674, 0.0, PhaseType.AQUEOUS)
    GdO2_minus = Species("GdO2-", None, ["Gd", "O"], 0.8107512, -1.0, PhaseType.AQUEOUS)
    GdHCO3_plus2 = Species("GdHCO3+2", None, ["Gd", "H", "C", "O"], 2.2182668399999996, 2.0, PhaseType.AQUEOUS)
    GdCl_plus2 = Species("GdCl+2", None, ["Gd", "Cl"], 2.192703, 2.0, PhaseType.AQUEOUS)
    GdCl2_plus = Species("GdCl2+", None, ["Gd", "Cl"], 1.2281559999999998, 1.0, PhaseType.AQUEOUS)
    GdCl3_aq = Species("GdCl3(aq)", None, ["Gd", "Cl"], 0.263609, 0.0, PhaseType.AQUEOUS)
    GdCl4_minus = Species("GdCl4-", None, ["Gd", "Cl"], 0.7009380000000001, -1.0, PhaseType.AQUEOUS)
    GdH2PO4_plus2 = Species("GdH2PO4+2", None, ["Gd", "H", "P", "O"], 2.254237241, 2.0, PhaseType.AQUEOUS)
    GdNO3_plus2 = Species("GdNO3+2", None, ["Gd", "N", "O"], 2.2192548999999997, 2.0, PhaseType.AQUEOUS)
    GdF_plus2 = Species("GdF+2", None, ["Gd", "F"], 2.1762484029999998, 2.0, PhaseType.AQUEOUS)
    GdF2_plus = Species("GdF2+", None, ["Gd", "F"], 1.1952468059999999, 1.0, PhaseType.AQUEOUS)
    GdF3_aq = Species("GdF3(aq)", None, ["Gd", "F"], 0.214245209, 0.0, PhaseType.AQUEOUS)
    GdF4_minus = Species("GdF4-", None, ["Gd", "F"], 0.766756388, -1.0, PhaseType.AQUEOUS)
    GdSO4_plus = Species("GdSO4+", None, ["Gd", "S", "O"], 1.2533125999999999, 1.0, PhaseType.AQUEOUS)
    TbCO3_plus = Species("TbCO3+", None, ["Tb", "C", "O"], 1.21893424, 1.0, PhaseType.AQUEOUS)
    TbOH_plus2 = Species("TbOH+2", None, ["Tb", "O", "H"], 2.1759326800000003, 2.0, PhaseType.AQUEOUS)
    TbO_plus = Species("TbO+", None, ["Tb", "O"], 1.17492474, 1.0, PhaseType.AQUEOUS)
    TbO2H_aq = Species("TbO2H(aq)", None, ["Tb", "O", "H"], 0.19193208, 0.0, PhaseType.AQUEOUS)
    TbO2_minus = Species("TbO2-", None, ["Tb", "O"], 0.80907586, -1.0, PhaseType.AQUEOUS)
    TbHCO3_plus2 = Species("TbHCO3+2", None, ["Tb", "H", "C", "O"], 2.21994218, 2.0, PhaseType.AQUEOUS)
    TbCl_plus2 = Species("TbCl+2", None, ["Tb", "Cl"], 2.19437834, 2.0, PhaseType.AQUEOUS)
    TbCl2_plus = Species("TbCl2+", None, ["Tb", "Cl"], 1.2298313399999998, 1.0, PhaseType.AQUEOUS)
    TbCl3_aq = Species("TbCl3(aq)", None, ["Tb", "Cl"], 0.26528434, 0.0, PhaseType.AQUEOUS)
    TbCl4_minus = Species("TbCl4-", None, ["Tb", "Cl"], 0.69926266, -1.0, PhaseType.AQUEOUS)
    TbH2PO4_plus2 = Species("TbH2PO4+2", None, ["Tb", "H", "P", "O"], 2.255912581, 2.0, PhaseType.AQUEOUS)
    TbNO3_plus2 = Species("TbNO3+2", None, ["Tb", "N", "O"], 2.22093024, 2.0, PhaseType.AQUEOUS)
    TbF_plus2 = Species("TbF+2", None, ["Tb", "F"], 2.177923743, 2.0, PhaseType.AQUEOUS)
    TbF2_plus = Species("TbF2+", None, ["Tb", "F"], 1.196922146, 1.0, PhaseType.AQUEOUS)
    TbF3_aq = Species("TbF3(aq)", None, ["Tb", "F"], 0.21592054900000002, 0.0, PhaseType.AQUEOUS)
    TbF4_minus = Species("TbF4-", None, ["Tb", "F"], 0.765081048, -1.0, PhaseType.AQUEOUS)
    TbSO4_plus = Species("TbSO4+", None, ["Tb", "S", "O"], 1.25498794, 1.0, PhaseType.AQUEOUS)
    DyCO3_plus = Species("DyCO3+", None, ["Dy", "C", "O"], 1.2225089000000002, 1.0, PhaseType.AQUEOUS)
    DyHCO3_plus2 = Species("DyHCO3+2", None, ["Dy", "H", "C", "O"], 2.22351684, 2.0, PhaseType.AQUEOUS)
    DyCl_plus2 = Species("DyCl+2", None, ["Dy", "Cl"], 2.197953, 2.0, PhaseType.AQUEOUS)
    DyCl2_plus = Species("DyCl2+", None, ["Dy", "Cl"], 1.233406, 1.0, PhaseType.AQUEOUS)
    DyCl3_aq = Species("DyCl3(aq)", None, ["Dy", "Cl"], 0.268859, 0.0, PhaseType.AQUEOUS)
    DyCl4_minus = Species("DyCl4-", None, ["Dy", "Cl"], 0.6956880000000001, -1.0, PhaseType.AQUEOUS)
    DyH2PO4_plus2 = Species("DyH2PO4+2", None, ["Dy", "H", "P", "O"], 2.259487241, 2.0, PhaseType.AQUEOUS)
    DyNO3_plus2 = Species("DyNO3+2", None, ["Dy", "N", "O"], 2.2245049, 2.0, PhaseType.AQUEOUS)
    DyF_plus2 = Species("DyF+2", None, ["Dy", "F"], 2.181498403, 2.0, PhaseType.AQUEOUS)
    DyF2_plus = Species("DyF2+", None, ["Dy", "F"], 1.200496806, 1.0, PhaseType.AQUEOUS)
    DyF3_aq = Species("DyF3(aq)", None, ["Dy", "F"], 0.21949520900000002, 0.0, PhaseType.AQUEOUS)
    DyF4_minus = Species("DyF4-", None, ["Dy", "F"], 0.761506388, -1.0, PhaseType.AQUEOUS)
    DyOH_plus2 = Species("DyOH+2", None, ["Dy", "O", "H"], 2.1795073400000002, 2.0, PhaseType.AQUEOUS)
    DyO_plus = Species("DyO+", None, ["Dy", "O"], 1.1784994000000002, 1.0, PhaseType.AQUEOUS)
    DyO2H_aq = Species("DyO2H(aq)", None, ["Dy", "O", "H"], 0.19550674, 0.0, PhaseType.AQUEOUS)
    DyO2_minus = Species("DyO2-", None, ["Dy", "O"], 0.8055012, -1.0, PhaseType.AQUEOUS)
    DySO4_plus = Species("DySO4+", None, ["Dy", "S", "O"], 1.2585626, 1.0, PhaseType.AQUEOUS)
    HoCO3_plus = Species("HoCO3+", None, ["Ho", "C", "O"], 1.2249392200000002, 1.0, PhaseType.AQUEOUS)
    HoHCO3_plus2 = Species("HoHCO3+2", None, ["Ho", "H", "C", "O"], 2.2259471599999996, 2.0, PhaseType.AQUEOUS)
    HoCl_plus2 = Species("HoCl+2", None, ["Ho", "Cl"], 2.20038332, 2.0, PhaseType.AQUEOUS)
    HoCl2_plus = Species("HoCl2+", None, ["Ho", "Cl"], 1.23583632, 1.0, PhaseType.AQUEOUS)
    HoCl3_aq = Species("HoCl3(aq)", None, ["Ho", "Cl"], 0.27128932, 0.0, PhaseType.AQUEOUS)
    HoCl4_minus = Species("HoCl4-", None, ["Ho", "Cl"], 0.6932576800000001, -1.0, PhaseType.AQUEOUS)
    HoH2PO4_plus2 = Species("HoH2PO4+2", None, ["Ho", "H", "P", "O"], 2.2619175609999997, 2.0, PhaseType.AQUEOUS)
    HoNO3_plus2 = Species("HoNO3+2", None, ["Ho", "N", "O"], 2.2269352199999997, 2.0, PhaseType.AQUEOUS)
    HoF_plus2 = Species("HoF+2", None, ["Ho", "F"], 2.1839287229999997, 2.0, PhaseType.AQUEOUS)
    HoF2_plus = Species("HoF2+", None, ["Ho", "F"], 1.202927126, 1.0, PhaseType.AQUEOUS)
    HoF3_aq = Species("HoF3(aq)", None, ["Ho", "F"], 0.221925529, 0.0, PhaseType.AQUEOUS)
    HoF4_minus = Species("HoF4-", None, ["Ho", "F"], 0.759076068, -1.0, PhaseType.AQUEOUS)
    HoOH_plus2 = Species("HoOH+2", None, ["Ho", "O", "H"], 2.18193766, 2.0, PhaseType.AQUEOUS)
    HoO_plus = Species("HoO+", None, ["Ho", "O"], 1.1809297200000002, 1.0, PhaseType.AQUEOUS)
    HoO2H_aq = Species("HoO2H(aq)", None, ["Ho", "O", "H"], 0.19793706, 0.0, PhaseType.AQUEOUS)
    HoO2_minus = Species("HoO2-", None, ["Ho", "O"], 0.80307088, -1.0, PhaseType.AQUEOUS)
    HoSO4_plus = Species("HoSO4+", None, ["Ho", "S", "O"], 1.26099292, 1.0, PhaseType.AQUEOUS)
    ErCO3_plus = Species("ErCO3+", None, ["Er", "C", "O"], 1.2272679000000002, 1.0, PhaseType.AQUEOUS)
    ErHCO3_plus2 = Species("ErHCO3+2", None, ["Er", "H", "C", "O"], 2.22827584, 2.0, PhaseType.AQUEOUS)
    ErCl_plus2 = Species("ErCl+2", None, ["Er", "Cl"], 2.202712, 2.0, PhaseType.AQUEOUS)
    ErCl2_plus = Species("ErCl2+", None, ["Er", "Cl"], 1.238165, 1.0, PhaseType.AQUEOUS)
    ErCl3_aq = Species("ErCl3(aq)", None, ["Er", "Cl"], 0.273618, 0.0, PhaseType.AQUEOUS)
    ErCl4_minus = Species("ErCl4-", None, ["Er", "Cl"], 0.6909289999999999, -1.0, PhaseType.AQUEOUS)
    ErH2PO4_plus2 = Species("ErH2PO4+2", None, ["Er", "H", "P", "O"], 2.264246241, 2.0, PhaseType.AQUEOUS)
    ErNO3_plus2 = Species("ErNO3+2", None, ["Er", "N", "O"], 2.2292639, 2.0, PhaseType.AQUEOUS)
    ErF_plus2 = Species("ErF+2", None, ["Er", "F"], 2.186257403, 2.0, PhaseType.AQUEOUS)
    ErF2_plus = Species("ErF2+", None, ["Er", "F"], 1.205255806, 1.0, PhaseType.AQUEOUS)
    ErF3_aq = Species("ErF3(aq)", None, ["Er", "F"], 0.22425420899999998, 0.0, PhaseType.AQUEOUS)
    ErF4_minus = Species("ErF4-", None, ["Er", "F"], 0.756747388, -1.0, PhaseType.AQUEOUS)
    ErOH_plus2 = Species("ErOH+2", None, ["Er", "O", "H"], 2.18426634, 2.0, PhaseType.AQUEOUS)
    ErO_plus = Species("ErO+", None, ["Er", "O"], 1.1832584000000002, 1.0, PhaseType.AQUEOUS)
    ErO2H_aq = Species("ErO2H(aq)", None, ["Er", "O", "H"], 0.20026574, 0.0, PhaseType.AQUEOUS)
    ErO2_minus = Species("ErO2-", None, ["Er", "O"], 0.8007422, -1.0, PhaseType.AQUEOUS)
    ErSO4_plus = Species("ErSO4+", None, ["Er", "S", "O"], 1.2633216, 1.0, PhaseType.AQUEOUS)
    TmCO3_plus = Species("TmCO3+", None, ["Tm", "C", "O"], 1.2289431100000001, 1.0, PhaseType.AQUEOUS)
    TmHCO3_plus2 = Species("TmHCO3+2", None, ["Tm", "H", "C", "O"], 2.22995105, 2.0, PhaseType.AQUEOUS)
    TmCl_plus2 = Species("TmCl+2", None, ["Tm", "Cl"], 2.20438721, 2.0, PhaseType.AQUEOUS)
    TmCl2_plus = Species("TmCl2+", None, ["Tm", "Cl"], 1.2398402099999999, 1.0, PhaseType.AQUEOUS)
    TmCl3_aq = Species("TmCl3(aq)", None, ["Tm", "Cl"], 0.27529321, 0.0, PhaseType.AQUEOUS)
    TmCl4_minus = Species("TmCl4-", None, ["Tm", "Cl"], 0.68925379, -1.0, PhaseType.AQUEOUS)
    TmH2PO4_plus2 = Species("TmH2PO4+2", None, ["Tm", "H", "P", "O"], 2.265921451, 2.0, PhaseType.AQUEOUS)
    TmNO3_plus2 = Species("TmNO3+2", None, ["Tm", "N", "O"], 2.23093911, 2.0, PhaseType.AQUEOUS)
    TmF_plus2 = Species("TmF+2", None, ["Tm", "F"], 2.187932613, 2.0, PhaseType.AQUEOUS)
    TmF2_plus = Species("TmF2+", None, ["Tm", "F"], 1.206931016, 1.0, PhaseType.AQUEOUS)
    TmF3_aq = Species("TmF3(aq)", None, ["Tm", "F"], 0.22592941900000002, 0.0, PhaseType.AQUEOUS)
    TmF4_minus = Species("TmF4-", None, ["Tm", "F"], 0.755072178, -1.0, PhaseType.AQUEOUS)
    TmOH_plus2 = Species("TmOH+2", None, ["Tm", "O", "H"], 2.1859415500000003, 2.0, PhaseType.AQUEOUS)
    TmO_plus = Species("TmO+", None, ["Tm", "O"], 1.18493361, 1.0, PhaseType.AQUEOUS)
    TmO2H_aq = Species("TmO2H(aq)", None, ["Tm", "O", "H"], 0.20194095, 0.0, PhaseType.AQUEOUS)
    TmO2_minus = Species("TmO2-", None, ["Tm", "O"], 0.79906699, -1.0, PhaseType.AQUEOUS)
    TmSO4_plus = Species("TmSO4+", None, ["Tm", "S", "O"], 1.26499681, 1.0, PhaseType.AQUEOUS)
    YbCO3_plus = Species("YbCO3+", None, ["Yb", "C", "O"], 1.2330489000000002, 1.0, PhaseType.AQUEOUS)
    YbOH_plus2 = Species("YbOH+2", None, ["Yb", "O", "H"], 2.19004734, 2.0, PhaseType.AQUEOUS)
    YbO_plus = Species("YbO+", None, ["Yb", "O"], 1.1890394000000002, 1.0, PhaseType.AQUEOUS)
    YbO2H_aq = Species("YbO2H(aq)", None, ["Yb", "O", "H"], 0.20604674, 0.0, PhaseType.AQUEOUS)
    YbO2_minus = Species("YbO2-", None, ["Yb", "O"], 0.7949612, -1.0, PhaseType.AQUEOUS)
    YbHCO3_plus2 = Species("YbHCO3+2", None, ["Yb", "H", "C", "O"], 2.2340568399999996, 2.0, PhaseType.AQUEOUS)
    YbCl_plus2 = Species("YbCl+2", None, ["Yb", "Cl"], 2.208493, 2.0, PhaseType.AQUEOUS)
    YbCl2_plus = Species("YbCl2+", None, ["Yb", "Cl"], 1.243946, 1.0, PhaseType.AQUEOUS)
    YbCl3_aq = Species("YbCl3(aq)", None, ["Yb", "Cl"], 0.279399, 0.0, PhaseType.AQUEOUS)
    YbCl4_minus = Species("YbCl4-", None, ["Yb", "Cl"], 0.6851480000000001, -1.0, PhaseType.AQUEOUS)
    YbH2PO4_plus2 = Species("YbH2PO4+2", None, ["Yb", "H", "P", "O"], 2.2700272409999998, 2.0, PhaseType.AQUEOUS)
    YbNO3_plus2 = Species("YbNO3+2", None, ["Yb", "N", "O"], 2.2350448999999997, 2.0, PhaseType.AQUEOUS)
    YbF_plus2 = Species("YbF+2", None, ["Yb", "F"], 2.1920384029999997, 2.0, PhaseType.AQUEOUS)
    YbF2_plus = Species("YbF2+", None, ["Yb", "F"], 1.211036806, 1.0, PhaseType.AQUEOUS)
    YbF3_aq = Species("YbF3(aq)", None, ["Yb", "F"], 0.23003520900000002, 0.0, PhaseType.AQUEOUS)
    YbF4_minus = Species("YbF4-", None, ["Yb", "F"], 0.750966388, -1.0, PhaseType.AQUEOUS)
    YbSO4_plus = Species("YbSO4+", None, ["Yb", "S", "O"], 1.2691026, 1.0, PhaseType.AQUEOUS)
    LuCO3_plus = Species("LuCO3+", None, ["Lu", "C", "O"], 1.2349759000000002, 1.0, PhaseType.AQUEOUS)
    LuOH_plus2 = Species("LuOH+2", None, ["Lu", "O", "H"], 2.1919743400000002, 2.0, PhaseType.AQUEOUS)
    LuO_plus = Species("LuO+", None, ["Lu", "O"], 1.1909664000000002, 1.0, PhaseType.AQUEOUS)
    LuO2H_aq = Species("LuO2H(aq)", None, ["Lu", "O", "H"], 0.20797374000000002, 0.0, PhaseType.AQUEOUS)
    LuO2_minus = Species("LuO2-", None, ["Lu", "O"], 0.7930342, -1.0, PhaseType.AQUEOUS)
    LuHCO3_plus2 = Species("LuHCO3+2", None, ["Lu", "H", "C", "O"], 2.23598384, 2.0, PhaseType.AQUEOUS)
    LuCl_plus2 = Species("LuCl+2", None, ["Lu", "Cl"], 2.21042, 2.0, PhaseType.AQUEOUS)
    LuCl2_plus = Species("LuCl2+", None, ["Lu", "Cl"], 1.245873, 1.0, PhaseType.AQUEOUS)
    LuCl3_aq = Species("LuCl3(aq)", None, ["Lu", "Cl"], 0.281326, 0.0, PhaseType.AQUEOUS)
    LuCl4_minus = Species("LuCl4-", None, ["Lu", "Cl"], 0.6832210000000001, -1.0, PhaseType.AQUEOUS)
    LuH2PO4_plus2 = Species("LuH2PO4+2", None, ["Lu", "H", "P", "O"], 2.271954241, 2.0, PhaseType.AQUEOUS)
    LuNO3_plus2 = Species("LuNO3+2", None, ["Lu", "N", "O"], 2.2369719, 2.0, PhaseType.AQUEOUS)
    LuF_plus2 = Species("LuF+2", None, ["Lu", "F"], 2.193965403, 2.0, PhaseType.AQUEOUS)
    LuF2_plus = Species("LuF2+", None, ["Lu", "F"], 1.212963806, 1.0, PhaseType.AQUEOUS)
    LuF3_aq = Species("LuF3(aq)", None, ["Lu", "F"], 0.23196220900000003, 0.0, PhaseType.AQUEOUS)
    LuF4_minus = Species("LuF4-", None, ["Lu", "F"], 0.749039388, -1.0, PhaseType.AQUEOUS)
    LuSO4_plus = Species("LuSO4+", None, ["Lu", "S", "O"], 1.2710296, 1.0, PhaseType.AQUEOUS)
    NaSO4_minus = Species("NaSO4-", None, ["Na", "S", "O"], 0.88094763, -1.0, PhaseType.AQUEOUS)
    ...
    BeCl_plus = Species("BeCl+", None, ["Be", "Cl"], 1.044465182, 1.0, PhaseType.AQUEOUS)
    BeCl2_aq = Species("BeCl2(aq)", None, ["Be", "Cl"], 0.079918182, 0.0, PhaseType.AQUEOUS)
    FeCl_plus2 = Species("FeCl+2", None, ["Fe", "Cl"], 2.091298, 2.0, PhaseType.AQUEOUS)
    CoCl_plus = Species("CoCl+", None, ["Co", "Cl"], 1.0943862, 1.0, PhaseType.AQUEOUS)
    CuCl_aq = Species("CuCl(aq)", None, ["Cu", "Cl"], 0.098999, 0.0, PhaseType.AQUEOUS)
    CuCl2_minus = Species("CuCl2-", None, ["Cu", "Cl"], 0.865548, -1.0, PhaseType.AQUEOUS)
    CuCl3_minus2 = Species("CuCl3-2", None, ["Cu", "Cl"], 1.8300949999999998, -2.0, PhaseType.AQUEOUS)
    CuCl_plus = Species("CuCl+", None, ["Cu", "Cl"], 1.098999, 1.0, PhaseType.AQUEOUS)
    CuCl2_aq = Species("CuCl2(aq)", None, ["Cu", "Cl"], 0.13445200000000002, 0.0, PhaseType.AQUEOUS)
    CuCl3_minus = Species("CuCl3-", None, ["Cu", "Cl"], 0.830095, -1.0, PhaseType.AQUEOUS)
    CuCl4_minus2 = Species("CuCl4-2", None, ["Cu", "Cl"], 1.7946419999999998, -2.0, PhaseType.AQUEOUS)
    CdCl_plus = Species("CdCl+", None, ["Cd", "Cl"], 1.147864, 1.0, PhaseType.AQUEOUS)
    CdCl2_aq = Species("CdCl2(aq)", None, ["Cd", "Cl"], 0.183317, 0.0, PhaseType.AQUEOUS)
    CdCl3_minus = Species("CdCl3-", None, ["Cd", "Cl"], 0.78123, -1.0, PhaseType.AQUEOUS)
    CdCl4_minus2 = Species("CdCl4-2", None, ["Cd", "Cl"], 1.745777, -2.0, PhaseType.AQUEOUS)
    TlCl_aq = Species("TlCl(aq)", None, ["Tl", "Cl"], 0.2398363, 0.0, PhaseType.AQUEOUS)
    TlCl_plus2 = Species("TlCl+2", None, ["Tl", "Cl"], 2.2398363, 2.0, PhaseType.AQUEOUS)
    AuCl_aq = Species("AuCl(aq)", None, ["Au", "Cl"], 0.23241954999999997, 0.0, PhaseType.AQUEOUS)
    AuCl2_minus = Species("AuCl2-", None, ["Au", "Cl"], 0.73212745, -1.0, PhaseType.AQUEOUS)
    AuCl3_minus2 = Species("AuCl3-2", None, ["Au", "Cl"], 1.69667445, -2.0, PhaseType.AQUEOUS)
    AuCl4_minus = Species("AuCl4-", None, ["Au", "Cl"], 0.66122145, -1.0, PhaseType.AQUEOUS)
    HgCl_plus = Species("HgCl+", None, ["Hg", "Cl"], 1.236043, 1.0, PhaseType.AQUEOUS)
    HgCl2_aq = Species("HgCl2(aq)", None, ["Hg", "Cl"], 0.27149599999999996, 0.0, PhaseType.AQUEOUS)
    HgCl3_minus = Species("HgCl3-", None, ["Hg", "Cl"], 0.693051, -1.0, PhaseType.AQUEOUS)
    HgCl4_minus2 = Species("HgCl4-2", None, ["Hg", "Cl"], 1.657598, -2.0, PhaseType.AQUEOUS)
    InCl_plus2 = Species("InCl+2", None, ["In", "Cl"], 2.150271, 2.0, PhaseType.AQUEOUS)
    BeF_plus = Species("BeF+", None, ["Be", "F"], 1.028010585, 1.0, PhaseType.AQUEOUS)
    BeF2_aq = Species("BeF2(aq)", None, ["Be", "F"], 0.047008988, 0.0, PhaseType.AQUEOUS)
    BeF3_minus = Species("BeF3-", None, ["Be", "F"], 0.933992609, -1.0, PhaseType.AQUEOUS)
    BeF4_minus2 = Species("BeF4-2", None, ["Be", "F"], 1.914994206, -2.0, PhaseType.AQUEOUS)
    MnF_plus = Species("MnF+", None, ["Mn", "F"], 1.0739364530000002, 1.0, PhaseType.AQUEOUS)
    FeF_plus = Species("FeF+", None, ["Fe", "F"], 1.074843403, 1.0, PhaseType.AQUEOUS)
    FeF_plus2 = Species("FeF+2", None, ["Fe", "F"], 2.074843403, 2.0, PhaseType.AQUEOUS)
    CoF_plus = Species("CoF+", None, ["Co", "F"], 1.0779316030000001, 1.0, PhaseType.AQUEOUS)
    NiF_plus = Species("NiF+", None, ["Ni", "F"], 1.077691803, 1.0, PhaseType.AQUEOUS)
    CuF_plus = Species("CuF+", None, ["Cu", "F"], 1.0825444030000002, 1.0, PhaseType.AQUEOUS)
    ZnF_plus = Species("ZnF+", None, ["Zn", "F"], 1.0844074030000002, 1.0, PhaseType.AQUEOUS)
    AgF_aq = Species("AgF(aq)", None, ["Ag", "F"], 0.126866603, 0.0, PhaseType.AQUEOUS)
    CdF_plus = Species("CdF+", None, ["Cd", "F"], 1.1314094030000001, 1.0, PhaseType.AQUEOUS)
    CdF2_aq = Species("CdF2(aq)", None, ["Cd", "F"], 0.150407806, 0.0, PhaseType.AQUEOUS)
    BaF_plus = Species("BaF+", None, ["Ba", "F"], 1.156325403, 1.0, PhaseType.AQUEOUS)
    TlF_aq = Species("TlF(aq)", None, ["Tl", "F"], 0.223381703, 0.0, PhaseType.AQUEOUS)
    HgF_plus = Species("HgF+", None, ["Hg", "F"], 1.2195884030000002, 1.0, PhaseType.AQUEOUS)
    InF_plus2 = Species("InF+2", None, ["In", "F"], 2.133816403, 2.0, PhaseType.AQUEOUS)
    PbF_plus = Species("PbF+", None, ["Pb", "F"], 1.2261984030000002, 1.0, PhaseType.AQUEOUS)
    PbF2_aq = Species("PbF2(aq)", None, ["Pb", "F"], 0.245196806, 0.0, PhaseType.AQUEOUS)
    Ag_HS_2_minus = Species("Ag(HS)2-", None, ["Ag", "H", "S"], 0.82598592, -1.0, PhaseType.AQUEOUS)
    Au_HS_2_minus = Species("Au(HS)2-", None, ["Au", "H", "S"], 0.73688757, -1.0, PhaseType.AQUEOUS)
    Pb_HS_2_aq = Species("Pb(HS)2(aq)", None, ["Pb", "H", "S"], 0.27334588, 0.0, PhaseType.AQUEOUS)
    Pb_HS_3_minus = Species("Pb(HS)3-", None, ["Pb", "H", "S"], 0.6935811799999999, -1.0, PhaseType.AQUEOUS)
    Mg_HSiO3_plus = Species("Mg(HSiO3)+", None, ["Mg", "H", "Si", "O"], 1.1013966400000001, 1.0, PhaseType.AQUEOUS)
    Ca_HSiO3_plus = Species("Ca(HSiO3)+", None, ["Ca", "H", "Si", "O"], 1.1171696400000002, 1.0, PhaseType.AQUEOUS)
    AlF_plus2 = Species("AlF+2", None, ["Al", "F"], 2.0459799409999997, 2.0, PhaseType.AQUEOUS)
    AlF2_plus = Species("AlF2+", None, ["Al", "F"], 1.064978344, 1.0, PhaseType.AQUEOUS)
    AlF3_aq = Species("AlF3(aq)", None, ["Al", "F"], 0.083976747, 0.0, PhaseType.AQUEOUS)
    AlF4_minus = Species("AlF4-", None, ["Al", "F"], 0.89702485, -1.0, PhaseType.AQUEOUS)
    Al_OH_2F2_minus = Species("Al(OH)2F2-", None, ["Al", "O", "H", "F"], 0.901006976, -1.0, PhaseType.AQUEOUS)
    ...
    AlSO4_plus = Species("AlSO4+", None, ["Al", "S", "O"], 1.123044138, 1.0, PhaseType.AQUEOUS)
    ...
    Acetate_minus = Species("Acetate-", None, ["C", "H", "O"], 0.94095598, -1.0, PhaseType.AQUEOUS)
    ...
    _2_Hydroxybutanoate = Species("2-Hydroxybutanoate", None, ["C", "H", "O"], 0.8969034200000001, -1.0, PhaseType.AQUEOUS)
    _2_Hydroxybutanoic_aq = Species("2-Hydroxybutanoic(aq)", None, ["C", "H", "O"], 0.10410452, 0.0, PhaseType.AQUEOUS)
    _2_Hydroxydecanoate = Species("2-Hydroxydecanoate", None, ["C", "H", "O"], 0.81274394, -1.0, PhaseType.AQUEOUS)
    ...
    _2_Hydroxyhexanoate = Species("2-Hydroxyhexanoate", None, ["C", "H", "O"], 0.86885026, -1.0, PhaseType.AQUEOUS)
    _2_Hydroxyhexanoic_aq = Species("2-Hydroxyhexanoic(aq)", None, ["C", "H", "O"], 0.13215768, 0.0, PhaseType.AQUEOUS)
    _2_Hydroxynonanoate = Species("2-Hydroxynonanoate", None, ["C", "H", "O"], 0.82677052, -1.0, PhaseType.AQUEOUS)
    _2_Hydroxynonanoic_aq = Species("2-Hydroxynonanoic(aq)", None, ["C", "H", "O"], 0.17423741999999998, 0.0, PhaseType.AQUEOUS)
    _2_Hydroxyoctanoate = Species("2-Hydroxyoctanoate", None, ["C", "H", "O"], 0.8407971, -1.0, PhaseType.AQUEOUS)
    ...
    A_Aminobutyric_aq = Species("A-Aminobutyric(aq)", None, ["C", "H", "O", "N"], 0.10311975999999999, 0.0, PhaseType.AQUEOUS)
    ...
    Adipate = Species("Adipate", None, ["C", "H", "O"], 1.8558746799999999, -2.0, PhaseType.AQUEOUS)
    ...
    Azelate = Species("Azelate", None, ["C", "H", "O"], 1.8137949400000002, -2.0, PhaseType.AQUEOUS)
    Benzene_aq = Species("Benzene(aq)", None, ["C", "H"], 0.07811183999999999, 0.0, PhaseType.AQUEOUS)
    Benzoate = Species("Benzoate", None, ["C", "H", "O"], 0.8788866000000001, -1.0, PhaseType.AQUEOUS)
    ...
    Decanoate = Species("Decanoate", None, ["C", "H", "O"], 0.82874334, -1.0, PhaseType.AQUEOUS)
    ...
    Dodecanoate = Species("Dodecanoate", None, ["C", "H", "O"], 0.8006901799999999, -1.0, PhaseType.AQUEOUS)
    Dodecanoic_Acid_aq = Species("Dodecanoic-Acid(aq)", None, ["C", "H", "O"], 0.20031775999999998, 0.0, PhaseType.AQUEOUS)
    ...
    Glutarate = Species("Glutarate", None, ["C", "H", "O"], 1.86990126, -2.0, PhaseType.AQUEOUS)
    ...
    H_Adipate = Species("H-Adipate", None, ["C", "H", "O"], 0.85486674, -1.0, PhaseType.AQUEOUS)
    H_Azelate = Species("H-Azelate", None, ["C", "H", "O"], 0.8127869999999999, -1.0, PhaseType.AQUEOUS)
    H_Glutarate = Species("H-Glutarate", None, ["C", "H", "O"], 0.8688933200000001, -1.0, PhaseType.AQUEOUS)
    H_Malonate = Species("H-Malonate", None, ["C", "H", "O"], 0.89694648, -1.0, PhaseType.AQUEOUS)
    H_Oxalate = Species("H-Oxalate", None, ["C", "H", "O"], 0.91097306, -1.0, PhaseType.AQUEOUS)
    H_Pimelate = Species("H-Pimelate", None, ["C", "H", "O"], 0.8408401600000001, -1.0, PhaseType.AQUEOUS)
    H_Sebacate = Species("H-Sebacate", None, ["C", "H", "O"], 0.79876042, -1.0, PhaseType.AQUEOUS)
    H_Suberate = Species("H-Suberate", None, ["C", "H", "O"], 0.82681358, -1.0, PhaseType.AQUEOUS)
    H_Succinate = Species("H-Succinate", None, ["C", "H", "O"], 0.8829199000000001, -1.0, PhaseType.AQUEOUS)
    Heptanoate = Species("Heptanoate", None, ["C", "H", "O"], 0.8708230800000001, -1.0, PhaseType.AQUEOUS)
    Heptanoic_Acid_aq = Species("Heptanoic-Acid(aq)", None, ["C", "H", "O"], 0.13018485999999999, 0.0, PhaseType.AQUEOUS)
    Hexanoate = Species("Hexanoate", None, ["C", "H", "O"], 0.88484966, -1.0, PhaseType.AQUEOUS)
    ...
    m_Toluate = Species("m-Toluate", None, ["C", "H", "O"], 0.8648600200000001, -1.0, PhaseType.AQUEOUS)
    m_Toluic_Acid_aq = Species("m-Toluic-Acid(aq)", None, ["C", "H", "O"], 0.13614792, 0.0, PhaseType.AQUEOUS)
    Malonate = Species("Malonate", None, ["C", "H", "O"], 1.89795442, -2.0, PhaseType.AQUEOUS)
    ...
    Nonanoate = Species("Nonanoate", None, ["C", "H", "O"], 0.84276992, -1.0, PhaseType.AQUEOUS)
    Nonanoic_Acid_aq = Species("Nonanoic-Acid(aq)", None, ["C", "H", "O"], 0.15823801999999998, 0.0, PhaseType.AQUEOUS)
    o_Toluate = Species("o-Toluate", None, ["C", "H", "O"], 0.8648600200000001, -1.0, PhaseType.AQUEOUS)
    o_Toluic_Acid_aq = Species("o-Toluic-Acid(aq)", None, ["C", "H", "O"], 0.13614792, 0.0, PhaseType.AQUEOUS)
    Octanoate = Species("Octanoate", None, ["C", "H", "O"], 0.8567965, -1.0, PhaseType.AQUEOUS)
    Octanoic_Acid_aq = Species("Octanoic-Acid(aq)", None, ["C", "H", "O"], 0.14421144, 0.0, PhaseType.AQUEOUS)
    Oxalate = Species("Oxalate", None, ["C", "O"], 1.911981, -2.0, PhaseType.AQUEOUS)
    Oxalic_Acid_aq = Species("Oxalic-Acid(aq)", None, ["C", "H", "O"], 0.09003488, 0.0, PhaseType.AQUEOUS)
    p_Toluate = Species("p-Toluate", None, ["C", "H", "O"], 0.8648600200000001, -1.0, PhaseType.AQUEOUS)
    ...
    Pimelate = Species("Pimelate", None, ["C", "H", "O"], 1.8418481, -2.0, PhaseType.AQUEOUS)
    ...
    Sebacate = Species("Sebacate", None, ["C", "H", "O"], 1.79976836, -2.0, PhaseType.AQUEOUS)
    ...
    Suberate = Species("Suberate", None, ["C", "H", "O"], 1.82782152, -2.0, PhaseType.AQUEOUS)
    Suberic_Acid_aq = Species("Suberic-Acid(aq)", None, ["C", "H", "O"], 0.17419436, 0.0, PhaseType.AQUEOUS)
    Succinate = Species("Succinate", None, ["C", "H", "O"], 1.8839278400000001, -2.0, PhaseType.AQUEOUS)
    ...
    Undecanoate = Species("Undecanoate", None, ["C", "H", "O"], 0.81471676, -1.0, PhaseType.AQUEOUS)
    ...
    CN_minus = Species("CN-", None, ["C", "N"], 0.9739825999999999, -1.0, PhaseType.AQUEOUS)
    OCN_minus = Species("OCN-", None, ["O", "C", "N"], 0.9579831999999999, -1.0, PhaseType.AQUEOUS)
    SCN_minus = Species("SCN-", None, ["S", "C", "N"], 0.9419175999999999, -1.0, PhaseType.AQUEOUS)
    SeCN_minus = Species("SeCN-", None, ["Se", "C", "N"], 0.8950225999999999, -1.0, PhaseType.AQUEOUS)
    Bi_Ac_plus2 = Species("Bi(Ac)+2", None, ["Bi", "C", "H", "O"], 2.2680244000000003, 2.0, PhaseType.AQUEOUS)
    Bi_Ac_2_plus = Species("Bi(Ac)2+", None, ["Bi", "C", "H", "O"], 1.32706842, 1.0, PhaseType.AQUEOUS)
    Bi_Ac_3_aq = Species("Bi(Ac)3(aq)", None, ["Bi", "C", "H", "O"], 0.38611244, 0.0, PhaseType.AQUEOUS)
    Dy_Ac_plus2 = Species("Dy(Ac)+2", None, ["Dy", "C", "H", "O"], 2.2215440200000005, 2.0, PhaseType.AQUEOUS)
    Dy_Ac_2_plus = Species("Dy(Ac)2+", None, ["Dy", "C", "H", "O"], 1.28058804, 1.0, PhaseType.AQUEOUS)
    Dy_Ac_3_aq = Species("Dy(Ac)3(aq)", None, ["Dy", "C", "H", "O"], 0.33963206, 0.0, PhaseType.AQUEOUS)
    Ho_Ac_plus2 = Species("Ho(Ac)+2", None, ["Ho", "C", "H", "O"], 2.2239743400000003, 2.0, PhaseType.AQUEOUS)
    Ho_Ac_2_plus = Species("Ho(Ac)2+", None, ["Ho", "C", "H", "O"], 1.28301836, 1.0, PhaseType.AQUEOUS)
    Ho_Ac_3_aq = Species("Ho(Ac)3(aq)", None, ["Ho", "C", "H", "O"], 0.34206238, 0.0, PhaseType.AQUEOUS)
    Er_Ac_plus2 = Species("Er(Ac)+2", None, ["Er", "C", "H", "O"], 2.2263030200000005, 2.0, PhaseType.AQUEOUS)
    Er_Ac_2_plus = Species("Er(Ac)2+", None, ["Er", "C", "H", "O"], 1.28534704, 1.0, PhaseType.AQUEOUS)
    Er_Ac_3_aq = Species("Er(Ac)3(aq)", None, ["Er", "C", "H", "O"], 0.34439105999999997, 0.0, PhaseType.AQUEOUS)
    Tm_Ac_plus2 = Species("Tm(Ac)+2", None, ["Tm", "C", "H", "O"], 2.2279782300000006, 2.0, PhaseType.AQUEOUS)
    Tm_Ac_2_plus = Species("Tm(Ac)2+", None, ["Tm", "C", "H", "O"], 1.28702225, 1.0, PhaseType.AQUEOUS)
    Tm_Ac_3_aq = Species("Tm(Ac)3(aq)", None, ["Tm", "C", "H", "O"], 0.34606627, 0.0, PhaseType.AQUEOUS)
    Be_Ac_plus = Species("Be(Ac)+", None, ["Be", "C", "H", "O"], 1.068056202, 1.0, PhaseType.AQUEOUS)
    Be_Ac_2_aq = Species("Be(Ac)2(aq)", None, ["Be", "C", "H", "O"], 0.12710022199999998, 0.0, PhaseType.AQUEOUS)
    Ra_Ac_plus = Species("Ra(Ac)+", None, ["Ra", "C", "H", "O"], 1.28504402, 1.0, PhaseType.AQUEOUS)
    ...
    Au_Ac_2_minus = Species("Au(Ac)2-", None, ["Au", "C", "H", "O"], 0.6849454100000001, -1.0, PhaseType.AQUEOUS)
    Li_Ac_aq = Species("Li(Ac)(aq)", None, ["Li", "C", "H", "O"], 0.06598502, 0.0, PhaseType.AQUEOUS)
    Li_Ac_2_minus = Species("Li(Ac)2-", None, ["Li", "C", "H", "O"], 0.87497096, -1.0, PhaseType.AQUEOUS)
    Na_Ac_aq = Species("Na(Ac)(aq)", None, ["Na", "C", "H", "O"], 0.08203379, 0.0, PhaseType.AQUEOUS)
    Na_Ac_2_minus = Species("Na(Ac)2-", None, ["Na", "C", "H", "O"], 0.8589221899999999, -1.0, PhaseType.AQUEOUS)
    K_Ac_aq = Species("K(Ac)(aq)", None, ["K", "C", "H", "O"], 0.09814232, 0.0, PhaseType.AQUEOUS)
    K_Ac_2_minus = Species("K(Ac)2-", None, ["K", "C", "H", "O"], 0.84281366, -1.0, PhaseType.AQUEOUS)
    Mg_Ac_plus = Species("Mg(Ac)+", None, ["Mg", "C", "H", "O"], 1.08334902, 1.0, PhaseType.AQUEOUS)
    Mg_Ac_2_aq = Species("Mg(Ac)2(aq)", None, ["Mg", "C", "H", "O"], 0.14239303999999997, 0.0, PhaseType.AQUEOUS)
    Sr_Ac_plus = Species("Sr(Ac)+", None, ["Sr", "C", "H", "O"], 1.14666402, 1.0, PhaseType.AQUEOUS)
    Sr_Ac_2_aq = Species("Sr(Ac)2(aq)", None, ["Sr", "C", "H", "O"], 0.20570803999999998, 0.0, PhaseType.AQUEOUS)
    Ba_Ac_plus = Species("Ba(Ac)+", None, ["Ba", "C", "H", "O"], 1.19637102, 1.0, PhaseType.AQUEOUS)
    ...
    Cu_Ac_2_minus = Species("Cu(Ac)2-", None, ["Cu", "C", "H", "O"], 0.81836596, -1.0, PhaseType.AQUEOUS)
    Rb_Ac_aq = Species("Rb(Ac)(aq)", None, ["Rb", "C", "H", "O"], 0.14451181999999999, 0.0, PhaseType.AQUEOUS)
    Rb_Ac_2_minus = Species("Rb(Ac)2-", None, ["Rb", "C", "H", "O"], 0.7964441600000001, -1.0, PhaseType.AQUEOUS)
    Tl_Ac_aq = Species("Tl(Ac)(aq)", None, ["Tl", "C", "H", "O"], 0.26342732, 0.0, PhaseType.AQUEOUS)
    Tl_Ac_2_minus = Species("Tl(Ac)2-", None, ["Tl", "C", "H", "O"], 0.6775286600000001, -1.0, PhaseType.AQUEOUS)
    Cs_Ac_aq = Species("Cs(Ac)(aq)", None, ["Cs", "C", "H", "O"], 0.19194947, 0.0, PhaseType.AQUEOUS)
    Cs_Ac_2_minus = Species("Cs(Ac)2-", None, ["Cs", "C", "H", "O"], 0.7490065100000001, -1.0, PhaseType.AQUEOUS)
    Pb_Ac_plus = Species("Pb(Ac)+", None, ["Pb", "C", "H", "O"], 1.26624402, 1.0, PhaseType.AQUEOUS)
    Pb_Ac_2_aq = Species("Pb(Ac)2(aq)", None, ["Pb", "C", "H", "O"], 0.32528804, 0.0, PhaseType.AQUEOUS)
    Mn_Ac_plus = Species("Mn(Ac)+", None, ["Mn", "C", "H", "O"], 1.11398207, 1.0, PhaseType.AQUEOUS)
    Mn_Ac_2_aq = Species("Mn(Ac)2(aq)", None, ["Mn", "C", "H", "O"], 0.17302609000000002, 0.0, PhaseType.AQUEOUS)
    Mn_Ac_3_minus = Species("Mn(Ac)3-", None, ["Mn", "C", "H", "O"], 0.76792989, -1.0, PhaseType.AQUEOUS)
    Co_Ac_plus = Species("Co(Ac)+", None, ["Co", "C", "H", "O"], 1.11797722, 1.0, PhaseType.AQUEOUS)
    Co_Ac_2_aq = Species("Co(Ac)2(aq)", None, ["Co", "C", "H", "O"], 0.17702123999999997, 0.0, PhaseType.AQUEOUS)
    Co_Ac_3_minus = Species("Co(Ac)3-", None, ["Co", "C", "H", "O"], 0.76393474, -1.0, PhaseType.AQUEOUS)
    Ni_Ac_plus = Species("Ni(Ac)+", None, ["Ni", "C", "H", "O"], 1.1177374199999999, 1.0, PhaseType.AQUEOUS)
    Ni_Ac_2_aq = Species("Ni(Ac)2(aq)", None, ["Ni", "C", "H", "O"], 0.17678144, 0.0, PhaseType.AQUEOUS)
    Ni_Ac_3_minus = Species("Ni(Ac)3-", None, ["Ni", "C", "H", "O"], 0.76417454, -1.0, PhaseType.AQUEOUS)
    Cu_Ac_plus = Species("Cu(Ac)+", None, ["Cu", "C", "H", "O"], 1.12259002, 1.0, PhaseType.AQUEOUS)
    Cu_Ac_2_aq = Species("Cu(Ac)2(aq)", None, ["Cu", "C", "H", "O"], 0.18163404, 0.0, PhaseType.AQUEOUS)
    Cu_Ac_3_minus = Species("Cu(Ac)3-", None, ["Cu", "C", "H", "O"], 0.75932194, -1.0, PhaseType.AQUEOUS)
    NH4_Ac_aq = Species("NH4(Ac)(aq)", None, ["N", "C", "H", "O"], 0.07708248, 0.0, PhaseType.AQUEOUS)
    NH4_Ac_2_minus = Species("NH4(Ac)2-", None, ["N", "C", "H", "O"], 0.8638735, -1.0, PhaseType.AQUEOUS)
    UO2_Ac_plus = Species("UO2(Ac)+", None, ["U", "C", "H", "O"], 1.32907173, 1.0, PhaseType.AQUEOUS)
    UO2_Ac_2_aq = Species("UO2(Ac)2(aq)", None, ["U", "C", "H", "O"], 0.38811575, 0.0, PhaseType.AQUEOUS)
    UO2_Ac_3_minus = Species("UO2(Ac)3-", None, ["U", "C", "H", "O"], 0.5528402299999999, -1.0, PhaseType.AQUEOUS)
    Ag_Ac_aq = Species("Ag(Ac)(aq)", None, ["Ag", "C", "H", "O"], 0.16691222, 0.0, PhaseType.AQUEOUS)
    Ag_Ac_2_minus = Species("Ag(Ac)2-", None, ["Ag", "C", "H", "O"], 0.7740437600000001, -1.0, PhaseType.AQUEOUS)
    Cd_Ac_plus = Species("Cd(Ac)+", None, ["Cd", "C", "H", "O"], 1.17145502, 1.0, PhaseType.AQUEOUS)
    Cd_Ac_2_aq = Species("Cd(Ac)2(aq)", None, ["Cd", "C", "H", "O"], 0.23049904, 0.0, PhaseType.AQUEOUS)
    Cd_Ac_3_minus = Species("Cd(Ac)3-", None, ["Cd", "C", "H", "O"], 0.7104569399999999, -1.0, PhaseType.AQUEOUS)
    Hg_Ac_plus = Species("Hg(Ac)+", None, ["Hg", "C", "H", "O"], 1.25963402, 1.0, PhaseType.AQUEOUS)
    Hg_Ac_2_aq = Species("Hg(Ac)2(aq)", None, ["Hg", "C", "H", "O"], 0.31867804, 0.0, PhaseType.AQUEOUS)
    Hg_Ac_3_minus = Species("Hg(Ac)3-", None, ["Hg", "C", "H", "O"], 0.6222779399999999, -1.0, PhaseType.AQUEOUS)
    Sc_Ac_plus2 = Species("Sc(Ac)+2", None, ["Sc", "C", "H", "O"], 2.1039999300000005, 2.0, PhaseType.AQUEOUS)
    Sc_Ac_2_plus = Species("Sc(Ac)2+", None, ["Sc", "C", "H", "O"], 1.16304395, 1.0, PhaseType.AQUEOUS)
    Sc_Ac_3_aq = Species("Sc(Ac)3(aq)", None, ["Sc", "C", "H", "O"], 0.22208797, 0.0, PhaseType.AQUEOUS)
    U_Ac_plus2 = Species("U(Ac)+2", None, ["U", "C", "H", "O"], 2.2970729300000006, 2.0, PhaseType.AQUEOUS)
    U_Ac_2_plus = Species("U(Ac)2+", None, ["U", "C", "H", "O"], 1.3561169499999999, 1.0, PhaseType.AQUEOUS)
    U_Ac_3_aq = Species("U(Ac)3(aq)", None, ["U", "C", "H", "O"], 0.41516096999999996, 0.0, PhaseType.AQUEOUS)
    Pr_Ac_plus2 = Species("Pr(Ac)+2", None, ["Pr", "C", "H", "O"], 2.1999516700000004, 2.0, PhaseType.AQUEOUS)
    Pr_Ac_2_plus = Species("Pr(Ac)2+", None, ["Pr", "C", "H", "O"], 1.25899569, 1.0, PhaseType.AQUEOUS)
    Pr_Ac_3_aq = Species("Pr(Ac)3(aq)", None, ["Pr", "C", "H", "O"], 0.31803971, 0.0, PhaseType.AQUEOUS)
    La_Ac_plus2 = Species("La(Ac)+2", None, ["La", "C", "H", "O"], 2.1979495200000003, 2.0, PhaseType.AQUEOUS)
    La_Ac_2_plus = Species("La(Ac)2+", None, ["La", "C", "H", "O"], 1.2569935399999999, 1.0, PhaseType.AQUEOUS)
    La_Ac_3_aq = Species("La(Ac)3(aq)", None, ["La", "C", "H", "O"], 0.31603756, 0.0, PhaseType.AQUEOUS)
    Nd_Ac_plus2 = Species("Nd(Ac)+2", None, ["Nd", "C", "H", "O"], 2.2032840200000003, 2.0, PhaseType.AQUEOUS)
    Nd_Ac_2_plus = Species("Nd(Ac)2+", None, ["Nd", "C", "H", "O"], 1.2623280399999999, 1.0, PhaseType.AQUEOUS)
    Nd_Ac_3_aq = Species("Nd(Ac)3(aq)", None, ["Nd", "C", "H", "O"], 0.32137206, 0.0, PhaseType.AQUEOUS)
    Ce_Ac_plus2 = Species("Ce(Ac)+2", None, ["Ce", "C", "H", "O"], 2.1991600200000003, 2.0, PhaseType.AQUEOUS)
    Ce_Ac_2_plus = Species("Ce(Ac)2+", None, ["Ce", "C", "H", "O"], 1.2582040399999999, 1.0, PhaseType.AQUEOUS)
    Ce_Ac_3_aq = Species("Ce(Ac)3(aq)", None, ["Ce", "C", "H", "O"], 0.31724806, 0.0, PhaseType.AQUEOUS)
    Gd_Ac_plus2 = Species("Gd(Ac)+2", None, ["Gd", "C", "H", "O"], 2.2162940200000003, 2.0, PhaseType.AQUEOUS)
    Gd_Ac_2_plus = Species("Gd(Ac)2+", None, ["Gd", "C", "H", "O"], 1.2753380399999998, 1.0, PhaseType.AQUEOUS)
    Gd_Ac_3_aq = Species("Gd(Ac)3(aq)", None, ["Gd", "C", "H", "O"], 0.33438206000000004, 0.0, PhaseType.AQUEOUS)
    Sm_Ac_plus2 = Species("Sm(Ac)+2", None, ["Sm", "C", "H", "O"], 2.2094040200000005, 2.0, PhaseType.AQUEOUS)
    Sm_Ac_2_plus = Species("Sm(Ac)2+", None, ["Sm", "C", "H", "O"], 1.26844804, 1.0, PhaseType.AQUEOUS)
    Sm_Ac_3_aq = Species("Sm(Ac)3(aq)", None, ["Sm", "C", "H", "O"], 0.32749206, 0.0, PhaseType.AQUEOUS)
    Yb_Ac_plus2 = Species("Yb(Ac)+2", None, ["Yb", "C", "H", "O"], 2.2320840200000003, 2.0, PhaseType.AQUEOUS)
    Yb_Ac_2_plus = Species("Yb(Ac)2+", None, ["Yb", "C", "H", "O"], 1.29112804, 1.0, PhaseType.AQUEOUS)
    Yb_Ac_3_aq = Species("Yb(Ac)3(aq)", None, ["Yb", "C", "H", "O"], 0.35017206, 0.0, PhaseType.AQUEOUS)
    Eu_Ac_plus2 = Species("Eu(Ac)+2", None, ["Eu", "C", "H", "O"], 2.2110080200000004, 2.0, PhaseType.AQUEOUS)
    Eu_Ac_2_plus = Species("Eu(Ac)2+", None, ["Eu", "C", "H", "O"], 1.27005204, 1.0, PhaseType.AQUEOUS)
    Eu_Ac_3_aq = Species("Eu(Ac)3(aq)", None, ["Eu", "C", "H", "O"], 0.32909606, 0.0, PhaseType.AQUEOUS)
    Y_Ac_plus2 = Species("Y(Ac)+2", None, ["Y", "C", "H", "O"], 2.1479498700000006, 2.0, PhaseType.AQUEOUS)
    Y_Ac_2_plus = Species("Y(Ac)2+", None, ["Y", "C", "H", "O"], 1.20699389, 1.0, PhaseType.AQUEOUS)
    Y_Ac_3_aq = Species("Y(Ac)3(aq)", None, ["Y", "C", "H", "O"], 0.26603791, 0.0, PhaseType.AQUEOUS)
    Lu_Ac_plus2 = Species("Lu(Ac)+2", None, ["Lu", "C", "H", "O"], 2.2340110200000005, 2.0, PhaseType.AQUEOUS)
    Lu_Ac_2_plus = Species("Lu(Ac)2+", None, ["Lu", "C", "H", "O"], 1.29305504, 1.0, PhaseType.AQUEOUS)
    Lu_Ac_3_aq = Species("Lu(Ac)3(aq)", None, ["Lu", "C", "H", "O"], 0.35209906, 0.0, PhaseType.AQUEOUS)
    Tb_Ac_plus2 = Species("Tb(Ac)+2", None, ["Tb", "C", "H", "O"], 2.2179693600000006, 2.0, PhaseType.AQUEOUS)
    Tb_Ac_2_plus = Species("Tb(Ac)2+", None, ["Tb", "C", "H", "O"], 1.2770133799999999, 1.0, PhaseType.AQUEOUS)
    Tb_Ac_3_aq = Species("Tb(Ac)3(aq)", None, ["Tb", "C", "H", "O"], 0.3360574, 0.0, PhaseType.AQUEOUS)
    Pb_Ac_3_minus = Species("Pb(Ac)3-", None, ["Pb", "C", "H", "O"], 0.6156679399999999, -1.0, PhaseType.AQUEOUS)
    Fe_Ac_plus = Species("Fe(Ac)+", None, ["Fe", "C", "H", "O"], 1.11488902, 1.0, PhaseType.AQUEOUS)
    Fe_Ac_2_aq = Species("Fe(Ac)2(aq)", None, ["Fe", "C", "H", "O"], 0.17393303999999998, 0.0, PhaseType.AQUEOUS)
    Zn_Ac_plus = Species("Zn(Ac)+", None, ["Zn", "C", "H", "O"], 1.12445302, 1.0, PhaseType.AQUEOUS)
    Zn_Ac_2_aq = Species("Zn(Ac)2(aq)", None, ["Zn", "C", "H", "O"], 0.18349704, 0.0, PhaseType.AQUEOUS)
    Zn_Ac_3_minus = Species("Zn(Ac)3-", None, ["Zn", "C", "H", "O"], 0.7574589399999999, -1.0, PhaseType.AQUEOUS)
    Ca_Ac_plus = Species("Ca(Ac)+", None, ["Ca", "C", "H", "O"], 1.09912202, 1.0, PhaseType.AQUEOUS)
    Ca_Ac_2_aq = Species("Ca(Ac)2(aq)", None, ["Ca", "C", "H", "O"], 0.15816604, 0.0, PhaseType.AQUEOUS)
    Al_Ac_plus2 = Species("Al(Ac)+2", None, ["Al", "C", "H", "O"], 2.0860255580000002, 2.0, PhaseType.AQUEOUS)
    Al_Ac_2_plus = Species("Al(Ac)2+", None, ["Al", "C", "H", "O"], 1.145069578, 1.0, PhaseType.AQUEOUS)
    Al_Ac_3_aq = Species("Al(Ac)3(aq)", None, ["Al", "C", "H", "O"], 0.204113598, 0.0, PhaseType.AQUEOUS)
    Lactate = Species("Lactate", None, ["C", "H", "O"], 0.91093, -1.0, PhaseType.AQUEOUS)
    ...
    Mg_Lac_plus = Species("Mg(Lac)+", None, ["Mg", "C", "H", "O"], 1.113375, 1.0, PhaseType.AQUEOUS)
    Mg_Lac_2_aq = Species("Mg(Lac)2(aq)", None, ["Mg", "C", "H", "O"], 0.20244499999999999, 0.0, PhaseType.AQUEOUS)
    Ca_Lac_plus = Species("Ca(Lac)+", None, ["Ca", "C", "H", "O"], 1.129148, 1.0, PhaseType.AQUEOUS)
    Ca_Lac_2_aq = Species("Ca(Lac)2(aq)", None, ["Ca", "C", "H", "O"], 0.21821800000000002, 0.0, PhaseType.AQUEOUS)
    Sr_Lac_plus = Species("Sr(Lac)+", None, ["Sr", "C", "H", "O"], 1.17669, 1.0, PhaseType.AQUEOUS)
    Sr_Lac_2_aq = Species("Sr(Lac)2(aq)", None, ["Sr", "C", "H", "O"], 0.26576, 0.0, PhaseType.AQUEOUS)
    Ba_Lac_plus = Species("Ba(Lac)+", None, ["Ba", "C", "H", "O"], 1.226397, 1.0, PhaseType.AQUEOUS)
    Ba_Lac_2_aq = Species("Ba(Lac)2(aq)", None, ["Ba", "C", "H", "O"], 0.315467, 0.0, PhaseType.AQUEOUS)
    Mn_Lac_plus = Species("Mn(Lac)+", None, ["Mn", "C", "H", "O"], 1.14400805, 1.0, PhaseType.AQUEOUS)
    Mn_Lac_2_aq = Species("Mn(Lac)2(aq)", None, ["Mn", "C", "H", "O"], 0.23307804999999998, 0.0, PhaseType.AQUEOUS)
    Co_Lac_plus = Species("Co(Lac)+", None, ["Co", "C", "H", "O"], 1.1480032, 1.0, PhaseType.AQUEOUS)
    Co_Lac_2_aq = Species("Co(Lac)2(aq)", None, ["Co", "C", "H", "O"], 0.23707319999999998, 0.0, PhaseType.AQUEOUS)
    Ni_Lac_plus = Species("Ni(Lac)+", None, ["Ni", "C", "H", "O"], 1.1477633999999999, 1.0, PhaseType.AQUEOUS)
    Ni_Lac_2_aq = Species("Ni(Lac)2(aq)", None, ["Ni", "C", "H", "O"], 0.2368334, 0.0, PhaseType.AQUEOUS)
    Cu_Lac_plus = Species("Cu(Lac)+", None, ["Cu", "C", "H", "O"], 1.152616, 1.0, PhaseType.AQUEOUS)
    Cu_Lac_2_aq = Species("Cu(Lac)2(aq)", None, ["Cu", "C", "H", "O"], 0.241686, 0.0, PhaseType.AQUEOUS)
    Zn_Lac_plus = Species("Zn(Lac)+", None, ["Zn", "C", "H", "O"], 1.154479, 1.0, PhaseType.AQUEOUS)
    Zn_Lac_2_aq = Species("Zn(Lac)2(aq)", None, ["Zn", "C", "H", "O"], 0.243549, 0.0, PhaseType.AQUEOUS)
    Cd_Lac_plus = Species("Cd(Lac)+", None, ["Cd", "C", "H", "O"], 1.201481, 1.0, PhaseType.AQUEOUS)
    Cd_Lac_2_aq = Species("Cd(Lac)2(aq)", None, ["Cd", "C", "H", "O"], 0.290551, 0.0, PhaseType.AQUEOUS)
    La_Lac_plus2 = Species("La(Lac)+2", None, ["La", "C", "H", "O"], 2.2279755, 2.0, PhaseType.AQUEOUS)
    Lu_Lac_plus2 = Species("Lu(Lac)+2", None, ["Lu", "C", "H", "O"], 2.264037, 2.0, PhaseType.AQUEOUS)
    Na_Lac_aq = Species("Na(Lac)(aq)", None, ["Na", "C", "H", "O"], 0.11205977, 0.0, PhaseType.AQUEOUS)
    Na_Lac_2_minus = Species("Na(Lac)2-", None, ["Na", "C", "H", "O"], 0.79887023, -1.0, PhaseType.AQUEOUS)
    K_Lac_aq = Species("K(Lac)(aq)", None, ["K", "C", "H", "O"], 0.1281683, 0.0, PhaseType.AQUEOUS)
    K_Lac_2_minus = Species("K(Lac)2-", None, ["K", "C", "H", "O"], 0.7827617, -1.0, PhaseType.AQUEOUS)
    Pb_Lac_plus = Species("Pb(Lac)+", None, ["Pb", "C", "H", "O"], 1.29627, 1.0, PhaseType.AQUEOUS)
    Pb_Lac_2_aq = Species("Pb(Lac)2(aq)", None, ["Pb", "C", "H", "O"], 0.38534, 0.0, PhaseType.AQUEOUS)
    Fe_Lac_plus = Species("Fe(Lac)+", None, ["Fe", "C", "H", "O"], 1.144915, 1.0, PhaseType.AQUEOUS)
    Fe_Lac_2_aq = Species("Fe(Lac)2(aq)", None, ["Fe", "C", "H", "O"], 0.233985, 0.0, PhaseType.AQUEOUS)
    Eu_Lac_plus = Species("Eu(Lac)+", None, ["Eu", "C", "H", "O"], 1.241034, 1.0, PhaseType.AQUEOUS)
    ...
    Glycolate = Species("Glycolate", None, ["C", "H", "O"], 0.92495658, -1.0, PhaseType.AQUEOUS)
    Li_Glyc_aq = Species("Li(Glyc)(aq)", None, ["Li", "C", "H", "O"], 0.08198442, 0.0, PhaseType.AQUEOUS)
    Mg_Glyc_plus = Species("Mg(Glyc)+", None, ["Mg", "C", "H", "O"], 1.09934842, 1.0, PhaseType.AQUEOUS)
    Mg_Glyc_2_aq = Species("Mg(Glyc)2(aq)", None, ["Mg", "C", "H", "O"], 0.17439184, 0.0, PhaseType.AQUEOUS)
    Ca_Glyc_plus = Species("Ca(Glyc)+", None, ["Ca", "C", "H", "O"], 1.1151214200000001, 1.0, PhaseType.AQUEOUS)
    Ca_Glyc_2_aq = Species("Ca(Glyc)2(aq)", None, ["Ca", "C", "H", "O"], 0.19016484, 0.0, PhaseType.AQUEOUS)
    Sr_Glyc_plus = Species("Sr(Glyc)+", None, ["Sr", "C", "H", "O"], 1.1626634200000001, 1.0, PhaseType.AQUEOUS)
    Sr_Glyc_2_aq = Species("Sr(Glyc)2(aq)", None, ["Sr", "C", "H", "O"], 0.23770684, 0.0, PhaseType.AQUEOUS)
    Ba_Glyc_plus = Species("Ba(Glyc)+", None, ["Ba", "C", "H", "O"], 1.21237042, 1.0, PhaseType.AQUEOUS)
    Ba_Glyc_2_aq = Species("Ba(Glyc)2(aq)", None, ["Ba", "C", "H", "O"], 0.28741384000000003, 0.0, PhaseType.AQUEOUS)
    Mn_Glyc_plus = Species("Mn(Glyc)+", None, ["Mn", "C", "H", "O"], 1.1299814700000002, 1.0, PhaseType.AQUEOUS)
    Mn_Glyc_2_aq = Species("Mn(Glyc)2(aq)", None, ["Mn", "C", "H", "O"], 0.20502489000000002, 0.0, PhaseType.AQUEOUS)
    Co_Glyc_plus = Species("Co(Glyc)+", None, ["Co", "C", "H", "O"], 1.13397662, 1.0, PhaseType.AQUEOUS)
    Co_Glyc_2_aq = Species("Co(Glyc)2(aq)", None, ["Co", "C", "H", "O"], 0.20902004, 0.0, PhaseType.AQUEOUS)
    Ni_Glyc_plus = Species("Ni(Glyc)+", None, ["Ni", "C", "H", "O"], 1.13373682, 1.0, PhaseType.AQUEOUS)
    Ni_Glyc_2_aq = Species("Ni(Glyc)2(aq)", None, ["Ni", "C", "H", "O"], 0.20878024, 0.0, PhaseType.AQUEOUS)
    Cu_Glyc_plus = Species("Cu(Glyc)+", None, ["Cu", "C", "H", "O"], 1.1385894200000002, 1.0, PhaseType.AQUEOUS)
    Cu_Glyc_2_aq = Species("Cu(Glyc)2(aq)", None, ["Cu", "C", "H", "O"], 0.21363284000000002, 0.0, PhaseType.AQUEOUS)
    Zn_Glyc_plus = Species("Zn(Glyc)+", None, ["Zn", "C", "H", "O"], 1.1404524200000001, 1.0, PhaseType.AQUEOUS)
    Zn_Glyc_2_aq = Species("Zn(Glyc)2(aq)", None, ["Zn", "C", "H", "O"], 0.21549584, 0.0, PhaseType.AQUEOUS)
    Cd_Glyc_plus = Species("Cd(Glyc)+", None, ["Cd", "C", "H", "O"], 1.1874544200000001, 1.0, PhaseType.AQUEOUS)
    Cd_Glyc_2_aq = Species("Cd(Glyc)2(aq)", None, ["Cd", "C", "H", "O"], 0.26249784, 0.0, PhaseType.AQUEOUS)
    Eu_Glyc_plus = Species("Eu(Glyc)+", None, ["Eu", "C", "H", "O"], 1.22700742, 1.0, PhaseType.AQUEOUS)
    ...
    Na_Glyc_2_minus = Species("Na(Glyc)2-", None, ["Na", "C", "H", "O"], 0.8269233899999999, -1.0, PhaseType.AQUEOUS)
    K_Glyc_aq = Species("K(Glyc)(aq)", None, ["K", "C", "H", "O"], 0.11414172, 0.0, PhaseType.AQUEOUS)
    K_Glyc_2_minus = Species("K(Glyc)2-", None, ["K", "C", "H", "O"], 0.81081486, -1.0, PhaseType.AQUEOUS)
    Pb_Glyc_plus = Species("Pb(Glyc)+", None, ["Pb", "C", "H", "O"], 1.2822434200000001, 1.0, PhaseType.AQUEOUS)
    Pb_Glyc_2_aq = Species("Pb(Glyc)2(aq)", None, ["Pb", "C", "H", "O"], 0.35728684, 0.0, PhaseType.AQUEOUS)
    Fe_Glyc_plus = Species("Fe(Glyc)+", None, ["Fe", "C", "H", "O"], 1.13088842, 1.0, PhaseType.AQUEOUS)
    ...
    Alanate = Species("Alanate", None, ["C", "H", "O", "N"], 0.9119147599999999, -1.0, PhaseType.AQUEOUS)
    Cd_Alan_plus = Species("Cd(Alan)+", None, ["Cd", "C", "H", "O", "N"], 1.2004962399999999, 1.0, PhaseType.AQUEOUS)
    Cd_Alan_2_aq = Species("Cd(Alan)2(aq)", None, ["Cd", "C", "H", "N", "O"], 0.28858148, 0.0, PhaseType.AQUEOUS)
    Ca_Alan_plus = Species("Ca(Alan)+", None, ["Ca", "C", "H", "O", "N"], 1.12816324, 1.0, PhaseType.AQUEOUS)
    Ca_Alan_2_aq = Species("Ca(Alan)2(aq)", None, ["Ca", "C", "H", "N", "O"], 0.21624848000000002, 0.0, PhaseType.AQUEOUS)
    Pb_Alan_plus = Species("Pb(Alan)+", None, ["Pb", "C", "H", "O", "N"], 1.29528524, 1.0, PhaseType.AQUEOUS)
    Pb_Alan_2_aq = Species("Pb(Alan)2(aq)", None, ["Pb", "C", "H", "N", "O"], 0.38337047999999996, 0.0, PhaseType.AQUEOUS)
    Mg_Alan_plus = Species("Mg(Alan)+", None, ["Mg", "C", "H", "N", "O"], 1.1123902399999999, 1.0, PhaseType.AQUEOUS)
    Mg_Alan_2_aq = Species("Mg(Alan)2(aq)", None, ["Mg", "C", "H", "N", "O"], 0.20047547999999998, 0.0, PhaseType.AQUEOUS)
    Sr_Alan_plus = Species("Sr(Alan)+", None, ["Sr", "C", "H", "N", "O"], 1.1757052399999999, 1.0, PhaseType.AQUEOUS)
    Sr_Alan_2_aq = Species("Sr(Alan)2(aq)", None, ["Sr", "C", "H", "N", "O"], 0.26379048, 0.0, PhaseType.AQUEOUS)
    Mn_Alan_plus = Species("Mn(Alan)+", None, ["Mn", "C", "H", "N", "O"], 1.14302329, 1.0, PhaseType.AQUEOUS)
    Mn_Alan_2_aq = Species("Mn(Alan)2(aq)", None, ["Mn", "C", "H", "N", "O"], 0.23110852999999998, 0.0, PhaseType.AQUEOUS)
    Co_Alan_plus = Species("Co(Alan)+", None, ["Co", "C", "H", "N", "O"], 1.1470184399999999, 1.0, PhaseType.AQUEOUS)
    Co_Alan_2_aq = Species("Co(Alan)2(aq)", None, ["Co", "C", "H", "N", "O"], 0.23510367999999998, 0.0, PhaseType.AQUEOUS)
    Ni_Alan_plus = Species("Ni(Alan)+", None, ["Ni", "C", "H", "N", "O"], 1.1467786399999997, 1.0, PhaseType.AQUEOUS)
    Ni_Alan_2_aq = Species("Ni(Alan)2(aq)", None, ["Ni", "C", "H", "N", "O"], 0.23486388000000002, 0.0, PhaseType.AQUEOUS)
    Cu_Alan_plus = Species("Cu(Alan)+", None, ["Cu", "C", "H", "N", "O"], 1.15163124, 1.0, PhaseType.AQUEOUS)
    Cu_Alan_2_aq = Species("Cu(Alan)2(aq)", None, ["Cu", "C", "H", "N", "O"], 0.23971648, 0.0, PhaseType.AQUEOUS)
    Zn_Alan_plus = Species("Zn(Alan)+", None, ["Zn", "C", "H", "N", "O"], 1.15349424, 1.0, PhaseType.AQUEOUS)
    Zn_Alan_2_aq = Species("Zn(Alan)2(aq)", None, ["Zn", "C", "H", "N", "O"], 0.27357828, 0.0, PhaseType.AQUEOUS)
    Ba_Alan_plus = Species("Ba(Alan)+", None, ["Ba", "C", "H", "N", "O"], 1.2254122399999998, 1.0, PhaseType.AQUEOUS)
    Ba_Alan_2_aq = Species("Ba(Alan)2(aq)", None, ["Ba", "C", "H", "N", "O"], 0.31349748, 0.0, PhaseType.AQUEOUS)
    Fe_Alan_plus = Species("Fe(Alan)+", None, ["Fe", "C", "H", "N", "O"], 1.1439302399999998, 1.0, PhaseType.AQUEOUS)
    Fe_Alan_2_aq = Species("Fe(Alan)2(aq)", None, ["Fe", "C", "H", "N", "O"], 0.23201548, 0.0, PhaseType.AQUEOUS)
    Eu_Alan_plus = Species("Eu(Alan)+", None, ["Eu", "C", "H", "N", "O"], 1.2400492399999998, 1.0, PhaseType.AQUEOUS)
    ...
    Glycinate = Species("Glycinate", None, ["C", "H", "O", "N"], 0.92594134, -1.0, PhaseType.AQUEOUS)
    Cd_Gly_plus = Species("Cd(Gly)+", None, ["Cd", "C", "H", "O", "N"], 1.18646966, 1.0, PhaseType.AQUEOUS)
    Cd_Gly_2_aq = Species("Cd(Gly)2(aq)", None, ["Cd", "C", "H", "N", "O"], 0.26052832, 0.0, PhaseType.AQUEOUS)
    Ca_Gly_plus = Species("Ca(Gly)+", None, ["Ca", "C", "H", "O", "N"], 1.11413666, 1.0, PhaseType.AQUEOUS)
    Ca_Gly_2_aq = Species("Ca(Gly)2(aq)", None, ["Ca", "C", "H", "N", "O"], 0.18819532, 0.0, PhaseType.AQUEOUS)
    Sr_Gly_plus = Species("Sr(Gly)+", None, ["Sr", "C", "H", "N", "O"], 1.16167866, 1.0, PhaseType.AQUEOUS)
    Sr_Gly_2_aq = Species("Sr(Gly)2(aq)", None, ["Sr", "C", "H", "N", "O"], 0.23573731999999997, 0.0, PhaseType.AQUEOUS)
    Mn_Gly_plus = Species("Mn(Gly)+", None, ["Mn", "C", "H", "N", "O"], 1.12899671, 1.0, PhaseType.AQUEOUS)
    Mn_Gly_2_aq = Species("Mn(Gly)2(aq)", None, ["Mn", "C", "H", "N", "O"], 0.20305537, 0.0, PhaseType.AQUEOUS)
    Fe_Gly_plus = Species("Fe(Gly)+", None, ["Fe", "C", "H", "N", "O"], 1.1299036599999999, 1.0, PhaseType.AQUEOUS)
    Fe_Gly_2_aq = Species("Fe(Gly)2(aq)", None, ["Fe", "C", "H", "N", "O"], 0.20396232000000003, 0.0, PhaseType.AQUEOUS)
    Co_Gly_plus = Species("Co(Gly)+", None, ["Co", "C", "H", "N", "O"], 1.13299186, 1.0, PhaseType.AQUEOUS)
    Co_Gly_2_aq = Species("Co(Gly)2(aq)", None, ["Co", "C", "H", "N", "O"], 0.20705052000000002, 0.0, PhaseType.AQUEOUS)
    Pb_Gly_plus = Species("Pb(Gly)+", None, ["Pb", "C", "H", "O", "N"], 1.28125866, 1.0, PhaseType.AQUEOUS)
    Pb_Gly_2_aq = Species("Pb(Gly)2(aq)", None, ["Pb", "C", "H", "N", "O"], 0.35531732, 0.0, PhaseType.AQUEOUS)
    Mg_Gly_plus = Species("Mg(Gly)+", None, ["Mg", "C", "H", "N", "O"], 1.09836366, 1.0, PhaseType.AQUEOUS)
    Mg_Gly_2_aq = Species("Mg(Gly)2(aq)", None, ["Mg", "C", "H", "N", "O"], 0.17242232000000002, 0.0, PhaseType.AQUEOUS)
    Ni_Gly_plus = Species("Ni(Gly)+", None, ["Ni", "C", "H", "N", "O"], 1.1327520599999998, 1.0, PhaseType.AQUEOUS)
    Ni_Gly_2_aq = Species("Ni(Gly)2(aq)", None, ["Ni", "C", "H", "N", "O"], 0.20681072, 0.0, PhaseType.AQUEOUS)
    Cu_Gly_plus = Species("Cu(Gly)+", None, ["Cu", "C", "H", "N", "O"], 1.13760466, 1.0, PhaseType.AQUEOUS)
    Cu_Gly_2_aq = Species("Cu(Gly)2(aq)", None, ["Cu", "C", "H", "N", "O"], 0.21166332, 0.0, PhaseType.AQUEOUS)
    Zn_Gly_plus = Species("Zn(Gly)+", None, ["Zn", "C", "H", "N", "O"], 1.13946766, 1.0, PhaseType.AQUEOUS)
    Zn_Gly_2_aq = Species("Zn(Gly)2(aq)", None, ["Zn", "C", "H", "N", "O"], 0.21352632, 0.0, PhaseType.AQUEOUS)
    Eu_Gly_plus = Species("Eu(Gly)+", None, ["Eu", "C", "H", "N", "O"], 1.22602266, 1.0, PhaseType.AQUEOUS)
    Eu_Gly_2_aq = Species("Eu(Gly)2(aq)", None, ["Eu", "C", "H", "N", "O"], 0.30008132, 0.0, PhaseType.AQUEOUS)
    Ba_Gly_plus = Species("Ba(Gly)+", None, ["Ba", "C", "H", "N", "O"], 1.21138566, 1.0, PhaseType.AQUEOUS)
    ...
    Formate = Species("Formate", None, ["H", "C", "O"], 0.9549825599999999, -1.0, PhaseType.AQUEOUS)
    Mg_For_plus = Species("Mg(For)+", None, ["Mg", "C", "H", "O"], 1.06932244, 1.0, PhaseType.AQUEOUS)
    Mg_For_2_aq = Species("Mg(For)2(aq)", None, ["Mg", "C", "H", "O"], 0.11433988, 0.0, PhaseType.AQUEOUS)
    Ca_For_plus = Species("Ca(For)+", None, ["Ca", "C", "H", "O"], 1.0850954400000001, 1.0, PhaseType.AQUEOUS)
    Ca_For_2_aq = Species("Ca(For)2(aq)", None, ["Ca", "C", "H", "O"], 0.13011288, 0.0, PhaseType.AQUEOUS)
    Sr_For_plus = Species("Sr(For)+", None, ["Sr", "C", "H", "O"], 1.13263744, 1.0, PhaseType.AQUEOUS)
    Sr_For_2_aq = Species("Sr(For)2(aq)", None, ["Sr", "C", "H", "O"], 0.17765488000000002, 0.0, PhaseType.AQUEOUS)
    Ba_For_plus = Species("Ba(For)+", None, ["Ba", "C", "H", "O"], 1.18234444, 1.0, PhaseType.AQUEOUS)
    Ba_For_2_aq = Species("Ba(For)2(aq)", None, ["Ba", "C", "H", "O"], 0.22736188000000002, 0.0, PhaseType.AQUEOUS)
    Cu_For_plus = Species("Cu(For)+", None, ["Cu", "C", "H", "O"], 1.1085634400000002, 1.0, PhaseType.AQUEOUS)
    Cu_For_2_aq = Species("Cu(For)2(aq)", None, ["Cu", "C", "H", "O"], 0.15358088, 0.0, PhaseType.AQUEOUS)
    Cd_For_plus = Species("Cd(For)+", None, ["Cd", "C", "H", "O"], 1.1574284400000001, 1.0, PhaseType.AQUEOUS)
    ...
    Na_For_2_minus = Species("Na(For)2-", None, ["Na", "C", "H", "O"], 0.88697535, -1.0, PhaseType.AQUEOUS)
    K_For_aq = Species("K(For)(aq)", None, ["K", "C", "H", "O"], 0.08411574, 0.0, PhaseType.AQUEOUS)
    K_For_2_minus = Species("K(For)2-", None, ["K", "C", "H", "O"], 0.87086682, -1.0, PhaseType.AQUEOUS)
    La_For_plus2 = Species("La(For)+2", None, ["La", "C", "H", "O"], 2.18392294, 2.0, PhaseType.AQUEOUS)
    La_For_2_plus = Species("La(For)2+", None, ["La", "C", "H", "O"], 1.22894038, 1.0, PhaseType.AQUEOUS)
    Eu_For_plus = Species("Eu(For)+", None, ["Eu", "C", "H", "O"], 1.19698144, 1.0, PhaseType.AQUEOUS)
    Eu_For_2_aq = Species("Eu(For)2(aq)", None, ["Eu", "C", "H", "O"], 0.24199887999999997, 0.0, PhaseType.AQUEOUS)
    U_For_plus2 = Species("U(For)+2", None, ["U", "C", "H", "O"], 2.2830463500000002, 2.0, PhaseType.AQUEOUS)
    U_For_2_plus = Species("U(For)2+", None, ["U", "C", "H", "O"], 1.32806379, 1.0, PhaseType.AQUEOUS)
    Eu_For_plus2 = Species("Eu(For)+2", None, ["Eu", "C", "H", "O"], 2.19698144, 2.0, PhaseType.AQUEOUS)
    Eu_For_2_plus = Species("Eu(For)2+", None, ["Eu", "C", "H", "O"], 1.2419988800000001, 1.0, PhaseType.AQUEOUS)
    Gd_For_plus2 = Species("Gd(For)+2", None, ["Gd", "C", "H", "O"], 2.20226744, 2.0, PhaseType.AQUEOUS)
    Gd_For_2_plus = Species("Gd(For)2+", None, ["Gd", "C", "H", "O"], 1.24728488, 1.0, PhaseType.AQUEOUS)
    Yb_For_plus2 = Species("Yb(For)+2", None, ["Yb", "C", "H", "O"], 2.21805744, 2.0, PhaseType.AQUEOUS)
    Yb_For_2_plus = Species("Yb(For)2+", None, ["Yb", "C", "H", "O"], 1.2630748800000002, 1.0, PhaseType.AQUEOUS)
    Pb_For_plus = Species("Pb(For)+", None, ["Pb", "C", "H", "O"], 1.2522174400000001, 1.0, PhaseType.AQUEOUS)
    Pb_For_2_aq = Species("Pb(For)2(aq)", None, ["Pb", "C", "H", "O"], 0.29723488, 0.0, PhaseType.AQUEOUS)
    Mn_For_plus = Species("Mn(For)+", None, ["Mn", "C", "H", "O"], 1.0999554900000001, 1.0, PhaseType.AQUEOUS)
    Mn_For_2_aq = Species("Mn(For)2(aq)", None, ["Mn", "C", "H", "O"], 0.14497293, 0.0, PhaseType.AQUEOUS)
    Co_For_plus = Species("Co(For)+", None, ["Co", "C", "H", "O"], 1.10395064, 1.0, PhaseType.AQUEOUS)
    Co_For_2_aq = Species("Co(For)2(aq)", None, ["Co", "C", "H", "O"], 0.14896808, 0.0, PhaseType.AQUEOUS)
    Ni_For_plus = Species("Ni(For)+", None, ["Ni", "C", "H", "O"], 1.10371084, 1.0, PhaseType.AQUEOUS)
    Ni_For_2_aq = Species("Ni(For)2(aq)", None, ["Ni", "C", "H", "O"], 0.14872828, 0.0, PhaseType.AQUEOUS)
    Zn_For_plus = Species("Zn(For)+", None, ["Zn", "C", "H", "O"], 1.1104264400000001, 1.0, PhaseType.AQUEOUS)
    Zn_For_2_aq = Species("Zn(For)2(aq)", None, ["Zn", "C", "H", "O"], 0.15544387999999998, 0.0, PhaseType.AQUEOUS)
    Fe_For_plus = Species("Fe(For)+", None, ["Fe", "C", "H", "O"], 1.10086244, 1.0, PhaseType.AQUEOUS)
    ...
    Propanoate = Species("Propanoate", None, ["C", "H", "O"], 0.9269294, -1.0, PhaseType.AQUEOUS)
    Mg_Prop_plus = Species("Mg(Prop)+", None, ["Mg", "C", "H", "O"], 1.0973756, 1.0, PhaseType.AQUEOUS)
    Mg_Prop_2_aq = Species("Mg(Prop)2(aq)", None, ["Mg", "C", "H", "O"], 0.1704462, 0.0, PhaseType.AQUEOUS)
    Ca_Prop_plus = Species("Ca(Prop)+", None, ["Ca", "C", "H", "O"], 1.1131486, 1.0, PhaseType.AQUEOUS)
    Ca_Prop_2_aq = Species("Ca(Prop)2(aq)", None, ["Ca", "C", "H", "O"], 0.1862192, 0.0, PhaseType.AQUEOUS)
    Sr_Prop_plus = Species("Sr(Prop)+", None, ["Sr", "C", "H", "O"], 1.1606906, 1.0, PhaseType.AQUEOUS)
    Sr_Prop_2_aq = Species("Sr(Prop)2(aq)", None, ["Sr", "C", "H", "O"], 0.2337612, 0.0, PhaseType.AQUEOUS)
    Ba_Prop_plus = Species("Ba(Prop)+", None, ["Ba", "C", "H", "O"], 1.2103975999999999, 1.0, PhaseType.AQUEOUS)
    Ba_Prop_2_aq = Species("Ba(Prop)2(aq)", None, ["Ba", "C", "H", "O"], 0.2834682, 0.0, PhaseType.AQUEOUS)
    Eu_Prop_plus = Species("Eu(Prop)+", None, ["Eu", "C", "H", "O"], 1.2250345999999999, 1.0, PhaseType.AQUEOUS)
    Eu_Prop_2_aq = Species("Eu(Prop)2(aq)", None, ["Eu", "C", "H", "O"], 0.29810519999999996, 0.0, PhaseType.AQUEOUS)
    Cu_Prop_plus = Species("Cu(Prop)+", None, ["Cu", "C", "H", "O"], 1.1366166, 1.0, PhaseType.AQUEOUS)
    Cu_Prop_2_aq = Species("Cu(Prop)2(aq)", None, ["Cu", "C", "H", "O"], 0.20968720000000002, 0.0, PhaseType.AQUEOUS)
    Cd_Prop_plus = Species("Cd(Prop)+", None, ["Cd", "C", "H", "O"], 1.1854816, 1.0, PhaseType.AQUEOUS)
    Cd_Prop_2_aq = Species("Cd(Prop)2(aq)", None, ["Cd", "C", "H", "O"], 0.2585522, 0.0, PhaseType.AQUEOUS)
    Pb_Prop_plus = Species("Pb(Prop)+", None, ["Pb", "C", "H", "O"], 1.2802706, 1.0, PhaseType.AQUEOUS)
    ...
    Na_Prop_2_minus = Species("Na(Prop)2-", None, ["Na", "C", "H", "O"], 0.83086903, -1.0, PhaseType.AQUEOUS)
    K_Prop_aq = Species("K(Prop)(aq)", None, ["K", "C", "H", "O"], 0.11216889999999999, 0.0, PhaseType.AQUEOUS)
    K_Prop_2_minus = Species("K(Prop)2-", None, ["K", "C", "H", "O"], 0.8147605, -1.0, PhaseType.AQUEOUS)
    La_Prop_plus2 = Species("La(Prop)+2", None, ["La", "C", "H", "O"], 2.2119761000000002, 2.0, PhaseType.AQUEOUS)
    La_Prop_2_plus = Species("La(Prop)2+", None, ["La", "C", "H", "O"], 1.2850466999999999, 1.0, PhaseType.AQUEOUS)
    Eu_Prop_plus2 = Species("Eu(Prop)+2", None, ["Eu", "C", "H", "O"], 2.2250346000000003, 2.0, PhaseType.AQUEOUS)
    Eu_Prop_2_plus = Species("Eu(Prop)2+", None, ["Eu", "C", "H", "O"], 1.2981052, 1.0, PhaseType.AQUEOUS)
    Gd_Prop_plus2 = Species("Gd(Prop)+2", None, ["Gd", "C", "H", "O"], 2.2303206, 2.0, PhaseType.AQUEOUS)
    Gd_Prop_2_plus = Species("Gd(Prop)2+", None, ["Gd", "C", "H", "O"], 1.3033911999999999, 1.0, PhaseType.AQUEOUS)
    Yb_Prop_plus2 = Species("Yb(Prop)+2", None, ["Yb", "C", "H", "O"], 2.2461106, 2.0, PhaseType.AQUEOUS)
    Yb_Prop_2_plus = Species("Yb(Prop)2+", None, ["Yb", "C", "H", "O"], 1.3191812, 1.0, PhaseType.AQUEOUS)
    U_Prop_plus2 = Species("U(Prop)+2", None, ["U", "C", "H", "O"], 2.3110995100000005, 2.0, PhaseType.AQUEOUS)
    U_Prop_2_plus = Species("U(Prop)2+", None, ["U", "C", "H", "O"], 1.38417011, 1.0, PhaseType.AQUEOUS)
    Co_Prop_plus = Species("Co(Prop)+", None, ["Co", "C", "H", "O"], 1.1320038, 1.0, PhaseType.AQUEOUS)
    Co_Prop_2_aq = Species("Co(Prop)2(aq)", None, ["Co", "C", "H", "O"], 0.2050744, 0.0, PhaseType.AQUEOUS)
    Ni_Prop_plus = Species("Ni(Prop)+", None, ["Ni", "C", "H", "O"], 1.1317639999999998, 1.0, PhaseType.AQUEOUS)
    Ni_Prop_2_aq = Species("Ni(Prop)2(aq)", None, ["Ni", "C", "H", "O"], 0.20483459999999998, 0.0, PhaseType.AQUEOUS)
    Zn_Prop_plus = Species("Zn(Prop)+", None, ["Zn", "C", "H", "O"], 1.1384796, 1.0, PhaseType.AQUEOUS)
    Zn_Prop_2_aq = Species("Zn(Prop)2(aq)", None, ["Zn", "C", "H", "O"], 0.21155019999999997, 0.0, PhaseType.AQUEOUS)
    Fe_Prop_plus = Species("Fe(Prop)+", None, ["Fe", "C", "H", "O"], 1.1289155999999998, 1.0, PhaseType.AQUEOUS)
    Fe_Prop_2_aq = Species("Fe(Prop)2(aq)", None, ["Fe", "C", "H", "O"], 0.2019862, 0.0, PhaseType.AQUEOUS)
    Mn_Prop_plus = Species("Mn(Prop)+", None, ["Mn", "C", "H", "O"], 1.12800865, 1.0, PhaseType.AQUEOUS)
    ...
    Butanoate = Species("Butanoate", None, ["C", "H", "O"], 0.9129028200000001, -1.0, PhaseType.AQUEOUS)
    U_But_plus2 = Species("U(But)+2", None, ["U", "C", "H", "O"], 2.3251260900000004, 2.0, PhaseType.AQUEOUS)
    U_But_2_plus = Species("U(But)2+", None, ["U", "C", "H", "O"], 1.41222327, 1.0, PhaseType.AQUEOUS)
    Eu_But_plus = Species("Eu(But)+", None, ["Eu", "C", "H", "O"], 1.23906118, 1.0, PhaseType.AQUEOUS)
    Eu_But_2_aq = Species("Eu(But)2(aq)", None, ["Eu", "C", "H", "O"], 0.32615836, 0.0, PhaseType.AQUEOUS)
    Mg_But_plus = Species("Mg(But)+", None, ["Mg", "C", "H", "O"], 1.11140218, 1.0, PhaseType.AQUEOUS)
    Ca_But_plus = Species("Ca(But)+", None, ["Ca", "C", "H", "O"], 1.12717518, 1.0, PhaseType.AQUEOUS)
    Ca_But_2_aq = Species("Ca(But)2(aq)", None, ["Ca", "C", "H", "O"], 0.21427236, 0.0, PhaseType.AQUEOUS)
    Sr_But_plus = Species("Sr(But)+", None, ["Sr", "C", "H", "O"], 1.17471718, 1.0, PhaseType.AQUEOUS)
    Sr_But_2_aq = Species("Sr(But)2(aq)", None, ["Sr", "C", "H", "O"], 0.26181436, 0.0, PhaseType.AQUEOUS)
    Ba_But_plus = Species("Ba(But)+", None, ["Ba", "C", "H", "O"], 1.22442418, 1.0, PhaseType.AQUEOUS)
    Ba_But_2_aq = Species("Ba(But)2(aq)", None, ["Ba", "C", "H", "O"], 0.31152136, 0.0, PhaseType.AQUEOUS)
    Cu_But_plus = Species("Cu(But)+", None, ["Cu", "C", "H", "O"], 1.15064318, 1.0, PhaseType.AQUEOUS)
    Cu_But_2_aq = Species("Cu(But)2(aq)", None, ["Cu", "C", "H", "O"], 0.23774035999999998, 0.0, PhaseType.AQUEOUS)
    Cd_But_plus = Species("Cd(But)+", None, ["Cd", "C", "H", "O"], 1.19950818, 1.0, PhaseType.AQUEOUS)
    ...
    Na_But_2_minus = Species("Na(But)2-", None, ["Na", "C", "H", "O"], 0.80281587, -1.0, PhaseType.AQUEOUS)
    K_But_aq = Species("K(But)(aq)", None, ["K", "C", "H", "O"], 0.12619548, 0.0, PhaseType.AQUEOUS)
    K_But_2_minus = Species("K(But)2-", None, ["K", "C", "H", "O"], 0.78670734, -1.0, PhaseType.AQUEOUS)
    La_But_plus2 = Species("La(But)+2", None, ["La", "C", "H", "O"], 2.22600268, 2.0, PhaseType.AQUEOUS)
    La_But_2_plus = Species("La(But)2+", None, ["La", "C", "H", "O"], 1.3130998599999997, 1.0, PhaseType.AQUEOUS)
    Eu_But_plus2 = Species("Eu(But)+2", None, ["Eu", "C", "H", "O"], 2.23906118, 2.0, PhaseType.AQUEOUS)
    Eu_But_2_plus = Species("Eu(But)2+", None, ["Eu", "C", "H", "O"], 1.3261583599999998, 1.0, PhaseType.AQUEOUS)
    Gd_But_plus2 = Species("Gd(But)+2", None, ["Gd", "C", "H", "O"], 2.24434718, 2.0, PhaseType.AQUEOUS)
    Gd_But_2_plus = Species("Gd(But)2+", None, ["Gd", "C", "H", "O"], 1.3314443599999997, 1.0, PhaseType.AQUEOUS)
    Yb_But_plus2 = Species("Yb(But)+2", None, ["Yb", "C", "H", "O"], 2.26013718, 2.0, PhaseType.AQUEOUS)
    Yb_But_2_plus = Species("Yb(But)2+", None, ["Yb", "C", "H", "O"], 1.34723436, 1.0, PhaseType.AQUEOUS)
    Pb_But_plus = Species("Pb(But)+", None, ["Pb", "C", "H", "O"], 1.29429718, 1.0, PhaseType.AQUEOUS)
    Pb_But_2_aq = Species("Pb(But)2(aq)", None, ["Pb", "C", "H", "O"], 0.38139436, 0.0, PhaseType.AQUEOUS)
    Mn_But_plus = Species("Mn(But)+", None, ["Mn", "C", "H", "O"], 1.14203523, 1.0, PhaseType.AQUEOUS)
    Mn_But_2_aq = Species("Mn(But)2(aq)", None, ["Mn", "C", "H", "O"], 0.22913241, 0.0, PhaseType.AQUEOUS)
    Ni_But_plus = Species("Ni(But)+", None, ["Ni", "C", "H", "O"], 1.14579058, 1.0, PhaseType.AQUEOUS)
    Ni_But_2_aq = Species("Ni(But)2(aq)", None, ["Ni", "C", "H", "O"], 0.23288776, 0.0, PhaseType.AQUEOUS)
    Zn_But_plus = Species("Zn(But)+", None, ["Zn", "C", "H", "O"], 1.15250618, 1.0, PhaseType.AQUEOUS)
    Zn_But_2_aq = Species("Zn(But)2(aq)", None, ["Zn", "C", "H", "O"], 0.23960336, 0.0, PhaseType.AQUEOUS)
    Fe_But_plus = Species("Fe(But)+", None, ["Fe", "C", "H", "O"], 1.14294218, 1.0, PhaseType.AQUEOUS)
    Fe_But_2_aq = Species("Fe(But)2(aq)", None, ["Fe", "C", "H", "O"], 0.23003936000000003, 0.0, PhaseType.AQUEOUS)
    Co_But_plus = Species("Co(But)+", None, ["Co", "C", "H", "O"], 1.14603038, 1.0, PhaseType.AQUEOUS)
    ...
    Pentanoate = Species("Pentanoate", None, ["C", "H", "O"], 0.89887624, -1.0, PhaseType.AQUEOUS)
    Ca_Pent_plus = Species("Ca(Pent)+", None, ["Ca", "C", "H", "O"], 1.14120176, 1.0, PhaseType.AQUEOUS)
    Ca_Pent_2_aq = Species("Ca(Pent)2(aq)", None, ["Ca", "C", "H", "O"], 0.24232552000000002, 0.0, PhaseType.AQUEOUS)
    Sr_Pent_plus = Species("Sr(Pent)+", None, ["Sr", "C", "H", "O"], 1.18874376, 1.0, PhaseType.AQUEOUS)
    Sr_Pent_2_aq = Species("Sr(Pent)2(aq)", None, ["Sr", "C", "H", "O"], 0.28986752, 0.0, PhaseType.AQUEOUS)
    Ba_Pent_plus = Species("Ba(Pent)+", None, ["Ba", "C", "H", "O"], 1.2384507599999999, 1.0, PhaseType.AQUEOUS)
    Ba_Pent_2_aq = Species("Ba(Pent)2(aq)", None, ["Ba", "C", "H", "O"], 0.33957452, 0.0, PhaseType.AQUEOUS)
    Cu_Pent_plus = Species("Cu(Pent)+", None, ["Cu", "C", "H", "O"], 1.16466976, 1.0, PhaseType.AQUEOUS)
    ...
    Na_Pent_2_minus = Species("Na(Pent)2-", None, ["Na", "C", "H", "O"], 0.7747627100000001, -1.0, PhaseType.AQUEOUS)
    K_Pent_aq = Species("K(Pent)(aq)", None, ["K", "C", "H", "O"], 0.14022206, 0.0, PhaseType.AQUEOUS)
    K_Pent_2_minus = Species("K(Pent)2-", None, ["K", "C", "H", "O"], 0.7586541800000001, -1.0, PhaseType.AQUEOUS)
    La_Pent_plus2 = Species("La(Pent)+2", None, ["La", "C", "H", "O"], 2.24002926, 2.0, PhaseType.AQUEOUS)
    La_Pent_2_plus = Species("La(Pent)2+", None, ["La", "C", "H", "O"], 1.34115302, 1.0, PhaseType.AQUEOUS)
    Eu_Pent_plus2 = Species("Eu(Pent)+2", None, ["Eu", "C", "H", "O"], 2.25308776, 2.0, PhaseType.AQUEOUS)
    Eu_Pent_2_plus = Species("Eu(Pent)2+", None, ["Eu", "C", "H", "O"], 1.35421152, 1.0, PhaseType.AQUEOUS)
    U_Pent_plus2 = Species("U(Pent)+2", None, ["U", "C", "H", "O"], 2.3391526700000003, 2.0, PhaseType.AQUEOUS)
    Eu_Pent_plus = Species("Eu(Pent)+", None, ["Eu", "C", "H", "O"], 1.2530877599999999, 1.0, PhaseType.AQUEOUS)
    Gd_Pent_plus2 = Species("Gd(Pent)+2", None, ["Gd", "C", "H", "O"], 2.25837376, 2.0, PhaseType.AQUEOUS)
    Gd_Pent_2_plus = Species("Gd(Pent)2+", None, ["Gd", "C", "H", "O"], 1.35949752, 1.0, PhaseType.AQUEOUS)
    Yb_Pent_plus2 = Species("Yb(Pent)+2", None, ["Yb", "C", "H", "O"], 2.27416376, 2.0, PhaseType.AQUEOUS)
    Yb_Pent_2_plus = Species("Yb(Pent)2+", None, ["Yb", "C", "H", "O"], 1.37528752, 1.0, PhaseType.AQUEOUS)
    Mg_Pent_plus = Species("Mg(Pent)+", None, ["Mg", "C", "H", "O"], 1.12542876, 1.0, PhaseType.AQUEOUS)
    Mg_Pent_2_aq = Species("Mg(Pent)2(aq)", None, ["Mg", "C", "H", "O"], 0.22655251999999998, 0.0, PhaseType.AQUEOUS)
    Pb_Pent_plus = Species("Pb(Pent)+", None, ["Pb", "C", "H", "O"], 1.30832376, 1.0, PhaseType.AQUEOUS)
    Pb_Pent_2_aq = Species("Pb(Pent)2(aq)", None, ["Pb", "C", "H", "O"], 0.40944752, 0.0, PhaseType.AQUEOUS)
    Co_Pent_plus = Species("Co(Pent)+", None, ["Co", "C", "H", "O"], 1.16005696, 1.0, PhaseType.AQUEOUS)
    Co_Pent_2_aq = Species("Co(Pent)2(aq)", None, ["Co", "C", "H", "O"], 0.26118072, 0.0, PhaseType.AQUEOUS)
    Ni_Pent_plus = Species("Ni(Pent)+", None, ["Ni", "C", "H", "O"], 1.1598171599999998, 1.0, PhaseType.AQUEOUS)
    Ni_Pent_2_aq = Species("Ni(Pent)2(aq)", None, ["Ni", "C", "H", "O"], 0.26094092, 0.0, PhaseType.AQUEOUS)
    Zn_Pent_plus = Species("Zn(Pent)+", None, ["Zn", "C", "H", "O"], 1.16653276, 1.0, PhaseType.AQUEOUS)
    Zn_Pent_2_aq = Species("Zn(Pent)2(aq)", None, ["Zn", "C", "H", "O"], 0.26765652, 0.0, PhaseType.AQUEOUS)
    Cd_Pent_plus = Species("Cd(Pent)+", None, ["Cd", "C", "H", "O"], 1.21353476, 1.0, PhaseType.AQUEOUS)
    Cd_Pent_2_aq = Species("Cd(Pent)2(aq)", None, ["Cd", "C", "H", "O"], 0.31465852, 0.0, PhaseType.AQUEOUS)
    Fe_Pent_plus = Species("Fe(Pent)+", None, ["Fe", "C", "H", "O"], 1.1569687599999998, 1.0, PhaseType.AQUEOUS)
    Fe_Pent_2_aq = Species("Fe(Pent)2(aq)", None, ["Fe", "C", "H", "O"], 0.25809252, 0.0, PhaseType.AQUEOUS)
    Mn_Pent_plus = Species("Mn(Pent)+", None, ["Mn", "C", "H", "O"], 1.15606181, 1.0, PhaseType.AQUEOUS)
